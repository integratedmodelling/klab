...
public interface IObservableService {
  ...
  interface Builder {
     ...
     * appropriately for the specific context and observables requested - e.g. a quality contextual
     * to a region will restrict the context, a quality inherent to an agent in a region will use
     * inherency etc.
     * 
     * @param context
     * @return the same builder this was called on, for chaining calls
     ...
     * ratio) these should be passed after the semantic type.
     * 
     ...
     * informative exception, but no error will be reported when the method is called. The
     ...
     * Add traits to the concept being built.
     * 
     * Pair with (@link {@link #withTrait(IConcept...)} as Java is WriteEverythingTwice, not
     * DontRepeatYourself.
     * 
     * @param concepts
     * @return the same builder this was called on, for chaining calls
     ...
     * not have those traits or roles.
     * 
     * Pair with (@link {@link #without(IConcept...)} as Java is WriteEverythingTwice, not
     * DontRepeatYourself.
     * 
     * @param concepts
     * @return the same builder this was called on, for chaining calls
    ...
    /**
     * Negate the concept (make it into its negation). Acts immediately on the concept in the
     * builder.
     * 
     * @return the same builder this was called on, for chaining calls
     */
   ...
   */
  boolean isCompatible(@NotNull IConcept o1, @NotNull IConcept o2);

  /**
   * Same as {@link #isCompatible(IConcept, IConcept)} but accepts flags to handle specific needs in
   ...
   * @return true if these are compatible observables
   */
  boolean isCompatible(@NotNull IConcept o1, @NotNull IConcept o2, int flags);
   ...
   *
   * @param from a {@link org.integratedmodelling.klab.api.knowledge.IObservable} object.
   * @param to a {@link org.integratedmodelling.klab.api.knowledge.IObservable} object.
   * @throws java.lang.IllegalArgumentException if observables are incompatible
   ...
   *
   * @param observable a {@link org.integratedmodelling.klab.api.knowledge.IObservable} object.
   * @throws java.lang.IllegalArgumentException if not an observable
