...
public interface IKnowledge extends ISemantic {
   ...
   * {@link org.integratedmodelling.kim.model.SemanticType}. It can be converted to a proper URN format by prefixing it with the
  ...
  /**
   * Return the domain of the owning namespace, or null if the knowledge is not part of any domain.
   *
  ...
  /**
   * All knowledge may have metadata, which may be empty. The metadata will contain the value of all
   * annotation properties recognized by k.LAB, indexed by the properties' k.LAB qualified name.
   * This also applies to concepts from OWL ontologies that did not originate in a k.LAB namespace.
   *
