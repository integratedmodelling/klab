...
public class Quantifier {
  ...
  public boolean equals(Object obj) {
    ...
    // harsh, but just returning false may lead to unnoticed errors with e.g. equals(Quantifier.ALL)
    // which
    // wouldn't work
    // even when it should. is() should be used for that, and it won't compare ranges.
    if (!(obj instanceof Quantifier)) {
      throw new IllegalArgumentException("comparing quantifier with non-quantifier");
    }
