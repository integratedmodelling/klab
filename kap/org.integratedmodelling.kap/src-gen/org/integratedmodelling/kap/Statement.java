 ...
 * </ul>
 *
 * @see org.integratedmodelling.kap.KapPackage#getStatement()
 * @model
 * @generated
 */
public interface Statement extends EObject
{
   ...
   * @see #setCall(Call)
   * @see org.integratedmodelling.kap.KapPackage#getStatement_Call()
  ...
  /**
   * Sets the value of the '{@link org.integratedmodelling.kap.Statement#getCall <em>Call</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setText(String)
   * @see org.integratedmodelling.kap.KapPackage#getStatement_Text()
   * @model
   * @generated
   */
  String getText();
  ...
  /**
   * Sets the value of the '{@link org.integratedmodelling.kap.Statement#getText <em>Text</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.integratedmodelling.kap.KapPackage#getStatement_Group()
   * @model containment="true"
   * @generated
   */
  EList<Call> getGroup();
