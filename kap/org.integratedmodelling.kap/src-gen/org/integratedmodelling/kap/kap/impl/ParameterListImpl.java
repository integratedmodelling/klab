 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.ParameterListImpl#getPairs <em>Pairs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
  ...
  {
    return KapPackage.Literals.PARAMETER_LIST;
  }
  ...
  public EList<KeyValuePair> getPairs()
  {
    if (pairs == null)
    {
      pairs = new EObjectContainmentEList<KeyValuePair>(KeyValuePair.class, this, KapPackage.PARAMETER_LIST__PAIRS);
    }
    return pairs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KapPackage.PARAMETER_LIST__PAIRS:
