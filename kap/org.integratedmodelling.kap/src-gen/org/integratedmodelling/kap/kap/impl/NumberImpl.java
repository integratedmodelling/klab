 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.NumberImpl#isNegative <em>Negative</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.NumberImpl#getReal <em>Real</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.NumberImpl#isLong <em>Long</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.NumberImpl#isDecimal <em>Decimal</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.NumberImpl#getDecimalPart <em>Decimal Part</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.NumberImpl#isExponential <em>Exponential</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.NumberImpl#isExpNegative <em>Exp Negative</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.NumberImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberImpl extends MinimalEObjectImpl.Container implements org.integratedmodelling.kap.kap.Number
{
  /**
  ...
  {
    return KapPackage.Literals.NUMBER;
  }
  ...
  public void setNegative(boolean newNegative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.NUMBER__NEGATIVE, oldNegative, negative));
  }
  ...
  public void setReal(int newReal)
  {
    ...
    real = newReal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.NUMBER__REAL, oldReal, real));
  }
  ...
  public void setLong(boolean newLong)
  {
    ...
    long_ = newLong;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.NUMBER__LONG, oldLong, long_));
  }
  ...
  public void setDecimal(boolean newDecimal)
  {
    ...
    decimal = newDecimal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.NUMBER__DECIMAL, oldDecimal, decimal));
  }
  ...
  public void setDecimalPart(int newDecimalPart)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.NUMBER__DECIMAL_PART, oldDecimalPart, decimalPart));
  }
  ...
  public void setExponential(boolean newExponential)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.NUMBER__EXPONENTIAL, oldExponential, exponential));
  }
  ...
  public void setExpNegative(boolean newExpNegative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.NUMBER__EXP_NEGATIVE, oldExpNegative, expNegative));
  }
  ...
  public void setExp(int newExp)
  {
    ...
    exp = newExp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.NUMBER__EXP, oldExp, exp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KapPackage.NUMBER__NEGATIVE:
        return isNegative();
      case KapPackage.NUMBER__REAL:
        return getReal();
      case KapPackage.NUMBER__LONG:
        return isLong();
      case KapPackage.NUMBER__DECIMAL:
        return isDecimal();
      case KapPackage.NUMBER__DECIMAL_PART:
        return getDecimalPart();
      case KapPackage.NUMBER__EXPONENTIAL:
        return isExponential();
      case KapPackage.NUMBER__EXP_NEGATIVE:
        return isExpNegative();
      case KapPackage.NUMBER__EXP:
        return getExp();
    }
