 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.MatchImpl#isId <em>Id</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.MatchImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.MatchImpl#isRegexp <em>Regexp</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.MatchImpl#isObservable <em>Observable</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.MatchImpl#isLiteral <em>Literal</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.MatchImpl#isText <em>Text</em>}</li>
 *   <li>{@link org.integratedmodelling.kap.kap.impl.MatchImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatchImpl extends MinimalEObjectImpl.Container implements Match
{
  ...
  {
    return KapPackage.Literals.MATCH;
  }
  ...
  public void setId(boolean newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__ID, oldId, id));
  }
  ...
  public NotificationChain basicSetBody(Body newBody, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__BODY, oldBody, newBody);
  ...
  public void setBody(Body newBody)
  {
    if (newBody != body)
    {
      ...
      if (body != null)
        msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KapPackage.MATCH__BODY, null, msgs);
      if (newBody != null)
        msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KapPackage.MATCH__BODY, null, msgs);
      msgs = basicSetBody(newBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__BODY, newBody, newBody));
  }
  ...
  public void setRegexp(boolean newRegexp)
  {
    ...
    regexp = newRegexp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__REGEXP, oldRegexp, regexp));
  }
  ...
  public void setObservable(boolean newObservable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__OBSERVABLE, oldObservable, observable));
  }
  ...
  public void setLiteral(boolean newLiteral)
  {
    ...
    literal = newLiteral;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__LITERAL, oldLiteral, literal));
  }
  ...
  public void setText(boolean newText)
  {
    ...
    text = newText;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__TEXT, oldText, text));
  }
  ...
  public NotificationChain basicSetArguments(ArgumentDeclaration newArguments, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__ARGUMENTS, oldArguments, newArguments);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setArguments(ArgumentDeclaration newArguments)
  {
    if (newArguments != arguments)
    {
      NotificationChain msgs = null;
      if (arguments != null)
        msgs = ((InternalEObject)arguments).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KapPackage.MATCH__ARGUMENTS, null, msgs);
      if (newArguments != null)
        msgs = ((InternalEObject)newArguments).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KapPackage.MATCH__ARGUMENTS, null, msgs);
      msgs = basicSetArguments(newArguments, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KapPackage.MATCH__ARGUMENTS, newArguments, newArguments));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KapPackage.MATCH__BODY:
        return basicSetBody(null, msgs);
      case KapPackage.MATCH__ARGUMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KapPackage.MATCH__ID:
        return isId();
      case KapPackage.MATCH__BODY:
        return getBody();
      case KapPackage.MATCH__REGEXP:
        return isRegexp();
      case KapPackage.MATCH__OBSERVABLE:
        return isObservable();
      case KapPackage.MATCH__LITERAL:
        return isLiteral();
      case KapPackage.MATCH__TEXT:
        return isText();
      case KapPackage.MATCH__ARGUMENTS:
        return getArguments();
    }
