 ...
 * </ul>
 *
 * @see org.integratedmodelling.kap.KapPackage#getActions()
 * @model
 * @generated
 */
public interface Actions extends EObject
{
   ...
   * @see #setBody(Body)
   * @see org.integratedmodelling.kap.KapPackage#getActions_Body()
   * @model containment="true"
   * @generated
   */
  Body getBody();
  ...
  /**
   * Sets the value of the '{@link org.integratedmodelling.kap.Actions#getBody <em>Body</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMatch(Match)
   * @see org.integratedmodelling.kap.KapPackage#getActions_Match()
   * @model containment="true"
   * @generated
   */
  Match getMatch();
  ...
  /**
   * Sets the value of the '{@link org.integratedmodelling.kap.Actions#getMatch <em>Match</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.integratedmodelling.kap.Match}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Matches</em>' containment reference list.
   * @see org.integratedmodelling.kap.KapPackage#getActions_Matches()
   * @model containment="true"
   * @generated
   */
