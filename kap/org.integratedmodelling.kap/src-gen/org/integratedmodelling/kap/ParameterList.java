 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kap.ParameterList#getPairs <em>Pairs</em>}</li>
 * </ul>
 *
 * @see org.integratedmodelling.kap.KapPackage#getParameterList()
 * @model
 * @generated
 */
public interface ParameterList extends EObject
{
   ...
   * The list contents are of type {@link org.integratedmodelling.kap.KeyValuePair}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Pairs</em>' containment reference list.
   * @see org.integratedmodelling.kap.KapPackage#getParameterList_Pairs()
