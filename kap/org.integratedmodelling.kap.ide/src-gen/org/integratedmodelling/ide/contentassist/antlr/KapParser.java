...
public class KapParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KapGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBodyAccess().getGroup_0_2(), "rule__Body__Group_0_2__0");
			...
			builder.put(grammarAccess.getValueAccess().getIdAssignment_1(), "rule__Value__IdAssignment_1");
			builder.put(grammarAccess.getValueAccess().getObservableAssignment_2(), "rule__Value__ObservableAssignment_2");
			builder.put(grammarAccess.getValueAccess().getExpressionAssignment_3(), "rule__Value__ExpressionAssignment_3");
			...
			builder.put(grammarAccess.getBodyAccess().getListAssignment_0_2_1(), "rule__Body__ListAssignment_0_2_1");
			...
			builder.put(grammarAccess.getBodyAccess().getGroupAssignment_1_1_1_1(), "rule__Body__GroupAssignment_1_1_1_1");
			...
			builder.put(grammarAccess.getActionsAccess().getBodyAssignment_0(), "rule__Actions__BodyAssignment_0");
			builder.put(grammarAccess.getActionsAccess().getMatchAssignment_1(), "rule__Actions__MatchAssignment_1");
			builder.put(grammarAccess.getActionsAccess().getMatchesAssignment_2_1(), "rule__Actions__MatchesAssignment_2_1");
			builder.put(grammarAccess.getActionsAccess().getMatchesAssignment_2_2(), "rule__Actions__MatchesAssignment_2_2");
