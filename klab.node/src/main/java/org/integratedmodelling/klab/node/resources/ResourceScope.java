 ...
 * be fleshed out to contextualize resources that contain dataflows.
 * 
 * @author Ferd
 *
 */
public class ResourceScope extends Parameters<String> implements IRuntimeScope {
    ...
    /**
     * Use when called from a JSON post request without additional inputs. May build dummy artifacts
     * for any additional outputs.
     * 
     * @param resource
     * @param geometry
     */
    ...
    /**
     * Use when called from a post request carrying input and everything else in a KlabData object.
     * This will build artifacts for the inputs and possibly for the outputs.
     * 
     * @param request
     */
    ...
    @Override
    public IState newNonsemanticState(String name,
            org.integratedmodelling.klab.api.provenance.IArtifact.Type type,
            IScale scale) {
        // TODO Auto-generated method stub
        return null;
    }
