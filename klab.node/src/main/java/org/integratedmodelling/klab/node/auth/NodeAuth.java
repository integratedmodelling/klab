...
//                throw e;
            ...
            // TODO need to respect the 'cls' claim - AuthenticationToken by default, or map to class
...
//                try {
//                    constructor = tokenClass.getConstructor(String.class, String.class, ROLE_COLLECTION_CLASS);
//                    result = constructor.newInstance(coreApplicationConfig.getPartnerId(), username, roles);
//                } catch (Exception e) {
//                    try {
...
//            }
            ...
            LocalDateTime issuedAt = org.integratedmodelling.klab.node.utils.DateTimeUtil.utcMsToUtcLocal(issuedAtUtcMs);
