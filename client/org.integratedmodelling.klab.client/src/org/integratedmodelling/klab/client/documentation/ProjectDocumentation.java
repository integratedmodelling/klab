...
public class ProjectDocumentation extends FileCatalog<ModelDocumentation> {
	...
	public ProjectDocumentation(IKimProject project) {
		super(new File(project.getRoot() + File.separator + "META-INF" + File.separator + "documentation.json"),
				ModelDocumentation.class, ModelDocumentation.class);
	}
}
