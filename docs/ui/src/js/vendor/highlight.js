...
hljs.registerLanguage('kim', function () {
  ...
  */
  ...
  function kim(hljs) {
    ...
    var ABSTRACT_QUALITIES = 'im:Frequency im:Age im:QualityRanking im:MonetaryValue im:Concordance hydrology:WeatherMediatedDepositionWaterVolume im:Depth im:Numerosity im:Width chemistry:ChemicalEnergy im:Resilience chemistry:Salinity hydrology.incubation:Moisture hydrology:SurfaceWaterVolume demography:IncomeInequality im:Preference demography:Poverty im:Length im:Capacity im:Quantity ecology:Diversity im:Balance hydrology:HorizontalWaterFlowVelocity im:Height im:Heterogeneity soil.incubation:WiltingPoint im:Energy im:Temperature im:Priority im:Mass im:Proportion hydrology:VerticalWaterFlowVelocity hydrology:GroundWaterVolume im:Amount im:Security im:Type im:Velocity im:Complexity economics:Wealth im:Duration im:Volume im:Direction im:Area im:Diversity im:Angle im:SpatialCoverage im:Density im:Weight';
    ...
    var CONFIGURATIONS = "demography:SocialNetwork earth:EarthCover es.aesthetics:Aesthetics ecology:WaterRetentionStructure earth:Bathymetry earth:LandCover earth:StreamNetwork es:GreenInfrastructure ecology:Biodiversity earth:Terrain ecology:Landscape soil:Horizon ecology:VegetationStructure";
