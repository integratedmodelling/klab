...
Collaborative and shared. +1 possible but we're working on one. Linguistic framework: separation of attributes, traits etc using composition rules. Examples.
