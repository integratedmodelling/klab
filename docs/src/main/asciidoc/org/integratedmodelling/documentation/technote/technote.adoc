...
URNs, geometry and content. Static or dynamic. Access uses a uniform protocol optimized for speed of transfer; interoperability at this level is guaranteed by adapters.

Adapters. (crowdsourcing too)
