...
import org.integratedmodelling.contrib.jgrapht.alg.shortestpath.GraphMeasurer;
import org.integratedmodelling.contrib.jgrapht.alg.util.NeighborCache;
...
public abstract class GraphMetrics
{
     ...
     * such as the graph radius, consider using {@link org.integratedmodelling.contrib.jgrapht.alg.shortestpath.GraphMeasurer}
     * instead.
     *
     ...
     * <p>
     * For more fine-grained control over this method, or if you need additional distance metrics
     * such as the graph diameter, consider using {@link org.integratedmodelling.contrib.jgrapht.alg.shortestpath.GraphMeasurer}
     * instead.
     *
     * @param graph input graph
     * @param <V> graph vertex type
