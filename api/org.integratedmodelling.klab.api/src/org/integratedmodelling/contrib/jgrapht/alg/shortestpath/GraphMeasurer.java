...
public class GraphMeasurer<V, E>
{
     ...
     *        {@link org.integratedmodelling.contrib.jgrapht.alg.shortestpath.JohnsonShortestPaths} (Runtime complexity:
     *        $O(|V||E| + |V|^2 log|V|)$) or
     *        {@link org.integratedmodelling.contrib.jgrapht.alg.shortestpath.FloydWarshallShortestPaths} (Runtime complexity:
     *        $O(|V|^3)$.
     */
