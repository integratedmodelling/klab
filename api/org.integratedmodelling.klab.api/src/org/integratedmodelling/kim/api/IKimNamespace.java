...
public interface IKimNamespace extends IKimStatement {
	...
	/**
	 * Sets the constraining scope for the models in the namespace. Models can only
	 * reduce the scope.
	 * 
	...
	/**
	 * The k.IM loader that loaded (or is loading) this namespace. Null during
	 * validation but valid during code generation.
	 * 
	 * @return
	 */
