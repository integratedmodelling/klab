...
public interface IKimConcept extends IKimStatement {
	...
	public enum ObservableRole {
		...
		/**
		 * temporal inherent is 'during each'. Support is partial. Not sure it's here to
		 * stay.
		 */
		TEMPORAL_INHERENT(true, "during each"), RELATIONSHIP_SOURCE(true, "linking"), RELATIONSHIP_TARGET(true, "to"),

		// other structural components
		VALUE_OPERATOR(false, ""), UNIT(false, "in"), CURRENCY(false, "in"), LOGICAL_OPERATOR(true, ""),
		INLINE_VALUE(false, ""), UNARY_OPERATOR(true, ""),
