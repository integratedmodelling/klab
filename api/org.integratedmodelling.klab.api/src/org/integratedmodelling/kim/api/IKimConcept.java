...
public interface IKimConcept extends IKimStatement {
    ...
    /**
     * Roles of each component of an observable expression, to ease modifications (e.g. in builders)
     * and inspect specific clauses. The conceptual components can be used to selectively remove
     * parts of the observable in observable inspection. The structural components are used to
     * report on admissible tokens during interactive building of observables.
     * 
     * FIXME this has inconsistent coverage and should be reorganized along with the APIs that use
     * it.
     */
    public enum ObservableRole {
        ...
        /*
         * these correspond to modifiers. FIXME make this consistent with others eventually - just
         * mention SemanticModifier instead of each of them individually. The SEMANTIC_MODIFIER role
         * is added for correct use, referring to all below.
         */
        CONTEXT(true, "within"),
        INHERENT(true, "of"),
    ...
    public static final EnumSet<Type> QUALITY_TYPES = EnumSet.of(Type.CLASS, Type.QUANTITY, Type.ENERGY,
            ...
            Type.PROPORTION,
            Type.PROBABILITY, Type.NUMEROSITY, Type.DISTANCE, Type.VALUE, Type.MONETARY_VALUE,
            Type.OCCURRENCE,
    ...
    public static final EnumSet<Type> ALL_QUALITY_TYPES = EnumSet.of(Type.CLASS, Type.QUALITY, Type.QUANTITY,
            Type.ENERGY, Type.ENTROPY, Type.LENGTH, Type.MASS, Type.VOLUME, Type.WEIGHT, Type.MONEY,
            Type.DURATION,
            Type.AREA, Type.ACCELERATION, Type.PRIORITY, Type.ELECTRIC_POTENTIAL, Type.CHARGE,
            Type.RESISTANCE,
            Type.RESISTIVITY, Type.PRESSURE, Type.ANGLE, Type.VELOCITY, Type.TEMPERATURE, Type.VISCOSITY,
            Type.UNCERTAINTY, Type.RATIO, Type.PROPORTION, Type.PROBABILITY, Type.NUMEROSITY, Type.DISTANCE,
            Type.VALUE,
    ...
    public static final EnumSet<Type> CONTINUOUS_QUALITY_TYPES = EnumSet.of(Type.QUANTITY, Type.ENERGY,
            ...
            Type.ANGLE, Type.VELOCITY, Type.TEMPERATURE, Type.VISCOSITY, Type.UNCERTAINTY, Type.RATIO,
            Type.PROPORTION,
            Type.PROBABILITY, Type.NUMEROSITY, Type.DISTANCE, Type.VALUE, Type.OCCURRENCE, Type.PRESENCE,
            Type.AMOUNT,
