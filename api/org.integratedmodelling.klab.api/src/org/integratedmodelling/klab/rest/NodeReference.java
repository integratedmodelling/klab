...
//		this.resources.addAll(capabilities.getResourceUrns());
    ...
    public String toString() {
        return "NodeReference [id=" + id + ", type=" + identityType + ", permissions=" + permissions + ", partner=" + partner
                + ", urls=" + urls + ", online=" + online + ", retryPeriodMinutes=" + retryPeriodMinutes + ", loadFactor="
                + loadFactor + ", incomingConnections=" + incomingConnections + ", outgoingConnections=" + outgoingConnections
                + "]";
    }
