...
/**
 * ACHTUNG need equals to work in order to work inside the IDE. For now using simple object equality
 * which is OK for the purposes. If equals() is overridden, ensure it's flawless and fast.
 * 
 * @author Ferd
 *
 */
public class SearchMatch {
    ...
    private int index;
    // A label that can be shown to the user to select the match type. Can be "Subject" or
    // "Operator" for example. The system can use it to categorize as it's always defined and
    // unique.
     ...
     */
    public SearchMatch(String matchId, String matchName, String matchDescription, IKimConcept.Type semanticType, String state,
    ...
    /**
     * Semantic type of match (one of the fundamental observable types). Can only be null in
     * non-semantic URN matches, not the common user case.
     * 
     * @param semanticType
     */
