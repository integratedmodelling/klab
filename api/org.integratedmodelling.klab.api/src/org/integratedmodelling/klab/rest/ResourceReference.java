...
public class ResourceReference {
	...
	/**
	 * One of these can be added by a resource adapter to check on the availability
	 * before use. If availability is DELAYED, the client should check the wait time
	 * and decide according to user workflow chosen.
	 * 
	 * @author Ferd
	 *
	 */
	...
	/**
	 * This will never be stored in a catalog: it's only for real-time operations
	 * such as contextualization of the resource before data are extracted.
	 */
