...
/**
 * String constants for BibTeX entry field names Copied from JabRef source. No
 * author in source file. See https://github.com/JabRef/jabref.
 */
public class BibTexFields {

	/**
	 * FV added - for now we just use this.
	 */
	public static final String EXAMPLE_CITATION = "examplecitation";
	...
	/**
	 * @param field
	 *            - field to get the display version for
	...
	public static List<String> getNotTextFieldNames() {
		return Arrays.asList(BibTexFields.DOI, BibTexFields.FILE, BibTexFields.URL, BibTexFields.URI, BibTexFields.ISBN,
				BibTexFields.ISSN, BibTexFields.MONTH, BibTexFields.DATE, BibTexFields.YEAR);
	}
