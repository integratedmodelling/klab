...
public interface IUnitService {
	 ...
	 * @return a {@link org.integratedmodelling.klab.api.data.mediation.IUnit}
	 *         object.
	 */
	 ...
	 * @param space
	 *            a
	 *            {@link org.integratedmodelling.klab.api.observations.scale.IExtent}
	 *            object.
	 * @return a boolean.
	 */
	...
	/**
	 * Return whether the observable needs units. This is true if the observable is
	 * a non-rescaled physical property or if it's an extensive count or money
	 * value, in which case the unit will be unitless but may express distribution
	 * over the context.
	 * 
	 * @param observable
	 * @return
