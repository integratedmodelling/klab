...
public interface IIndexingService {
	...
	public interface Match {
		...
		public enum Type {
			CONCEPT, PREFIX_OPERATOR, INFIX_OPERATOR, OBSERVATION, MODEL, MODIFIER, PRESET_OBSERVABLE, RESOURCE,
			SEPARATOR, OPEN_PARENTHESIS, CLOSED_PARENTHESIS, VALUE_OPERATOR
		}
