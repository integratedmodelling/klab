...
public interface ISession extends IEngineSessionIdentity, Closeable {
	...
	/**
	 * Observe a new context of the passed type, returning an asynchronous future.
	 * This is the primary, asynchronous context observation method for the k.LAB
	 * modeling API. Interactive sessions and applications use the ISessionState to
	 * organize and schedule observations. When this method is used, the task should
	 * not have started, so the user has a chance to apply listeners, scenarios and
	 * other options.
	 * 
	 * @param observable
	 * @param geometry
