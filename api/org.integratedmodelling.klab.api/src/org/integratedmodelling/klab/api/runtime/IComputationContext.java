...
public interface IComputationContext extends IParameters<String> {
    ...
    /**
     * Return the scheduler for the context, null if non-temporal, create it if not there if temporal.
     * 
     ...
     *        relationship.
     */
    IObjectArtifact newRelationship(IObservable observable, String name, IScale scale, IObjectArtifact source, IObjectArtifact target, IMetadata metadata);
