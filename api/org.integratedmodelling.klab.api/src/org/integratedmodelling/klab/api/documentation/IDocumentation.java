 ...
 * annotation, associated to one or more models or part of project-wide
 * documentation. Documentation objects are harvested at contextualization and
 * assembled on request, guided by the provenance graph, to produce a session's
 * documentation.
 * 
 * A model's documentation can use the \@insert tag to add project-wide
 * templates. Each consists of a set of templates, associated to triggers, each
 * composed of a list of calls to the reporting system. Each structure is be
 * translated into code expressions that will perform the actual reporting tasks
 * during contextualization.
 * 
 * Documentation implementations are specific to an action language and the
 * calling system must ensure they are chosen correctly.
 * 
...
public interface IDocumentation {
	...
	public static final int DOC_HTMLTAGS = 1;
	public static final int DOC_HTML = 1;
	public static final int DOC_FORMATTED = 1;
