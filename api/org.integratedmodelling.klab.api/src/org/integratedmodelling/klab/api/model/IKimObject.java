 ...
 * corresponds to it. Some concrete subclasses of IKimObject (at the moment {@link org.integratedmodelling.klab.api.model.IConceptDefinition} and
 * {@link org.integratedmodelling.klab.api.model.IObserver} an have children of the same type. The {@link org.integratedmodelling.klab.api.model.INamespace} will list the top-level objects
 * through {@link org.integratedmodelling.klab.api.model.INamespace#getObjects()} or the flattened tree of objects through
...
public interface IKimObject extends Serializable {
     ...
     * {@link org.integratedmodelling.klab.api.model.IConceptDefinition} and {@link org.integratedmodelling.klab.api.model.IObserver} have children.
     *
