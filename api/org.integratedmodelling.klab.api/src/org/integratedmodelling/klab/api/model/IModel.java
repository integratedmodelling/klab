 ...
 * within a context (the root context is always acknowledged through an {@link org.integratedmodelling.klab.api.model.IObserver}).
 *
...
public interface IModel extends IActiveKimObject, INamespaceQualified, IResolvable,
   ...
   * observable's name reported by {@link org.integratedmodelling.klab.api.knowledge.IObservable#getLocalName()} may be different as the same
