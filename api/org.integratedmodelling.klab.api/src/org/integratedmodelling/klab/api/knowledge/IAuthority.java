...
public interface IAuthority {
    ...
    /**
     * Write the documentation for the passed identity in the passed media type, which will be one
     * of those returned in the capabilities.
     * 
     * @param identityId
     * @param mediaType
     * @param destination
    ...
    /**
     * Called only if {@link #isSearchable()} returns true. Implementations must set the
     * {@link IMetadata#IM_KEY} to the unique identity ID that will produce the concept when called
     * in {@link #getIdentity(String)}. Remaining fields should be set so as to support the user in
