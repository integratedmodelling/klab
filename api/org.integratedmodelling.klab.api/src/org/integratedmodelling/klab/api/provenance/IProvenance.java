 ...
 * typically {@link IObservation}s. A model built by k.LAB (such as in learning)
 * is also an artifact: in this case, the model artifact is its {@link IKimModel
 * syntactic specification}, not a {@link IModel runtime} incarnation of the
 * model.
 * <p>
 ...
 * of plans) or {@link IModel models}.
 * <p>
 ...
 * the {@link IEngineIdentity} that built and ran it. All models run within a
 * dataflow are associated with it. One provenance graph collects all dataflows
 * run to compute all the artifacts within the same root context. The
 * opportunity to include nodes for partners and delegation will be explored
 * later.
 * <p>
