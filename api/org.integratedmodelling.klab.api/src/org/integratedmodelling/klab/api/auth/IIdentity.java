 ...
 * append themselves as a {@link IEngine}, then duplicate the
 * {@link IUserIdentity} as the default {@link IEngineUserIdentity}, to which
 * they can add others if local authentication is enabled. {@link ISession
 * Sessions} are appended to each IEngineUser, {@link IObservation observations}
...
public abstract interface IIdentity {
	 ...
	 *
	 * @param type a {@link org.integratedmodelling.klab.api.auth.IIdentity.Type}
	 *             object.
	 * @return a boolean.
	 */
