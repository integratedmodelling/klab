 ...
 * {@link org.integratedmodelling.klab.api.observations.scale.IScale#merge(ITopologicallyComparable, LogicalConnector)}
...
public interface ICoverage extends IScale {
	 ...
	 * {@inheritDoc}
	 *
	 * Reimplements {@link IScale#merge(ITopologicallyComparable, LogicalConnector)}
	 * to return a coverage and implement {@code ICoverage}-specific behavior. Note
	 * that this breaks the {@link IScale} contract by returning a coverage where
	 * the underlying scale is <strong>unmodified</strong>, but only its coverage
