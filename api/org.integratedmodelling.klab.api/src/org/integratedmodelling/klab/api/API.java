...
public interface API {
     ...
     * commitment to stability is made. The endpoints in this may duplicate others in specific
     * sub-components. All k.LAB clients should <em>only</em> use endpoints from the public API.
     * 
     * @author Ferd
     *
     */
    public interface PUBLIC {
         ...
         */
        public static final String SUBMIT_ESTIMATE = PUBLIC_BASE + "/submit/estimate/" + P_SESSION + "/"
                + P_ESTIMATE;

        /**
         * Retrieve the {@link ObservationReference} JSON bean that describes the passed
         * observation, which must be available.
         */
        public static final String RETRIEVE_OBSERVATION_DESCRIPTOR = PUBLIC_BASE + "/get/observation/"
                + P_SESSION + "/"
                + P_OBSERVATION;
    ...
    public interface ENGINE {
        ...
        public interface OBSERVATION {
             ...
             */
            public static final String RETRIEVE_DATAFLOW = "/engine/session/observation/dataflow/"
                    + P_CONTEXT;
