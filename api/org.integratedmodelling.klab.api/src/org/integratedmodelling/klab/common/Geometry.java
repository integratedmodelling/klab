...
public class Geometry implements IGeometry {
    ...
    /**
     * Create a geometry from the structured session bean but don't add a shape if it's there.
     * 
     * @param scaleRef
     * @return
     */
    ...
    static class DimensionImpl implements Dimension {
        ...
        // throw new IllegalArgumentException("getOffset() is not implemented on basic geometry
        // dimensions");
        // }
