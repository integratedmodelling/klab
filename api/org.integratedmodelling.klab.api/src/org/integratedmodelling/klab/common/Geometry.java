...
public class Geometry implements IGeometry {
     ...
     */
    public static final String PARAMETER_TIME_REPRESENTATION  = "trepresentation";
    ...
    /**
     * Time scope unit: one of millennium, century, decade, year, month, week, day, hour, minute, second, millisecond, nanosecond
     */
