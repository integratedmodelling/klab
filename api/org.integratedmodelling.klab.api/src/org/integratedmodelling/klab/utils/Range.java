...
public class Range implements IValueMediator {
    ...
    public Pair<Range, Pair<Double, Double>> snap(Range original, long nCells) {
        ...
        return new Pair<>(create(this.getLowerBound() + (leftGap > 0 ? (leftCells * cellWidth) : 0),
                this.getUpperBound() - (rightGap > 0 ? (rightCells * cellWidth) : 0)), new Pair<>(leftError, rightError));
    }
