...
public class WRBIdentity {
	...
	/**
	 * Invoke validation (just syntax for now, later composition). If valid, pass
	 * through without exceptions. Otherwise, throw the exception that contains the
	 * explanation and the identity itself.
	 * 
	...
	/**
	 * Return the shortest possible stable identifier for the identity. This is
	 * stable as long as the vocabulary URIs remain stable.
	 * 
	 * @return
	 */
	public String getShortId() {
