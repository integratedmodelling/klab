...
/**
 * Command history array. Use like any list of strings but call append() to add a line, which will bring
 * any existing line to the front of the list instead of adding another copy, and transparently persist 
 * the history to the history file in .thinklab/client.history. Calling add() will throw an exception.
 * 
