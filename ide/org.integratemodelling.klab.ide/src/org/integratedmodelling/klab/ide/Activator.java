...
public class Activator extends AbstractUIPlugin {
  ...
  public void start(BundleContext context) throws Exception {
    ...
    Kim.INSTANCE.setValidator(new Validator() {
      ...
      @Override
      public List<org.eclipse.xtext.util.Pair<String, Level>> validateFunction(
          IServiceCall functionCall, Set<IPrototype.Type> expected) {
      ...
      @Override
      public Object synchronizeNamespaceWithRuntime(IKimNamespace namespace) {
        // TODO Auto-generated method stub
        return null;
      }
