...
public class SearchView extends ViewPart {
    ...
    private StyledText paletteView;
    ...
    public void createPartControl(Composite parent) {
        ...
        // begin comment out
        paletteView = new StyledText(actionArea, SWT.BORDER | SWT.READ_ONLY | SWT.H_SCROLL | SWT.V_SCROLL);
    ...
    private void handleMessage(IMessage message) {
        ...
        case QueryStatus:
            ...
            Display.getDefault().asyncExec(() -> {
                paletteView.setText(status.getDescription() == null ? "" : status.getDescription());
            });
            break;
        default:
            break;
    ...
    private void createActions() {
        ...
        }
        {
            ...
            action_2.setImageDescriptor(
                    ResourceManager.getPluginImageDescriptor("org.eclipse.ui",
                            "/icons/full/etool16/save_edit.png"));
        }
        {
