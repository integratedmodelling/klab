    ...
    class LabelProvider implements ITableLabelProvider {
        ...
        public Image getColumnImage(Object element, int columnIndex) {
            return columnIndex == 0 && element instanceof EResourceReference
                    ? ResourceManager.getPluginImage(Activator.PLUGIN_ID, (((ResourceReference) element)
        ...
        }
        {
            ...
            mntmCopyUrn.addSelectionListener(new SelectionAdapter() {
                ...
                public void widgetSelected(SelectionEvent e) {
                    Object object = table.getSelection().length > 0 ? table.getSelection()[0].getData()
                            : null;
            ...
            MenuItem mntmPreviewResource = new MenuItem(menu, SWT.NONE);
            ...
            tableViewer.addDragSupport(DND.DROP_DEFAULT, new Transfer[] {
                    TextTransfer.getInstance(),
                    LocalSelectionTransfer.getTransfer() }, new DragSourceListener() {
