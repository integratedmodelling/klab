...
public class Activator extends AbstractUIPlugin {
    ...
    private void engineOn() {
        ...
        /*
         * offer to import any k.LAB local projects that are not in the workspace and have the engine load
         * those projects it does not have. TODO
        ...
        Display.getDefault().asyncExec(() -> {
            ...
            /*
             * find out which projects in our workspace are not known to the engine and
             * send them over.
             */
            List<File> projectFiles = new ArrayList<>();
            for (IProject project : Eclipse.INSTANCE.getProjects()) {
