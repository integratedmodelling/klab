...
public class KlabNavigatorActions {
	...
	public static void deleteNamespace(ENamespace namespace) {
		if (MessageDialog.openConfirm(Eclipse.INSTANCE.getShell(), "Confirm deletion",
	...
	public static void deleteScript(EScript script) {
	...
	public static void deleteTestCase(ETestCase testCase) {
