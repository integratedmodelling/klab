...
public class TestXViewerFactory extends XViewerFactory {
...
//    public static MyPreComputedColumn preComputedColumn = new MyPreComputedColumn();
    ...
    public TestXViewerFactory() {
       super("xviewer.test");

       registerColumns(Name_Col, Run_Col, Schedule_Time, Completed_Col, Run_Db, Task_Type,
