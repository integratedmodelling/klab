...
public class Pager extends Composite {
	...
	final PageSelector imageSelector;
	private List<Control> images = new ArrayList<>();
	 ...
	 *
	 */
	public Pager(final Composite parent, final int style) {
		super(parent, checkStyle(style));
		setLayout(new GridLayout());
		imageContainer = new Composite(this, SWT.NONE);
		imageContainer.setLayoutData(new GridData(GridData.FILL, GridData.FILL, true, true));
		imageSelector = new PageSelector(this, SWT.NONE);
...
//		imageContainer.setImage(images.get(selection));
	 ...
	 *                </ul>
	 */
	public void setImages(final List<Control> images) {
		checkWidget();
		if (images == null) {
			SWT.error(SWT.ERROR_NULL_ARGUMENT);
		}
