	...
	public UsingLogMapMatcher(){
		...
		try{
			...
			for (MappingObjectStr mapping: logmap2_mappings){
				OutAlign.println("Mapping: ");
				OutAlign.println("\t"+ mapping.getIRIStrEnt1());
				OutAlign.println("\t"+ mapping.getIRIStrEnt2());
				OutAlign.println("\t"+ mapping.getConfidence());
				
				//MappingObjectStr.EQ or MappingObjectStr.SUB or MappingObjectStr.SUP
				OutAlign.println("\t"+ mapping.getMappingDirection()); //Utilities.EQ;
				...
				OutAlign.println("\t"+ mapping.getTypeOfMapping());
