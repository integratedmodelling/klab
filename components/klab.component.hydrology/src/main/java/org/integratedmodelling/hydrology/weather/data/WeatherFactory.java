...
//     * CAUTION: long-running operation - about 3h on a powerful desktop. Better
//     * done on a real server with fast disks and used through REST.
//     */
...
//         * check paths first
//         */
//        File fPath = new File(Configuration.getApplicationPath());
...
//
//        if (!fPath.canWrite()) {
//            throw new KlabException("wmengine application path at "
//                    + Configuration.getApplicationPath() + " must be writable");
//        }
//        
//        /*
...
//            stationCount = WeatherKbox.get().count();
//        }
//        
...
//        }
//
//        File fInv = new File(dataPath + File.separator
//                + "ghcnd-inventory.txt");
//        File fSta = new File(dataPath + File.separator
//                + "ghcnd-stations.txt");
//
//        /**
...
//
//        WeatherKbox.get().getDatabase().preallocateConnection();
//
//        int i = 0;
...
//
//                } catch (Throwable e) {
//                    logger.error("Data for station " + i + "th station: " + ws
...
//        }
//
//        WeatherKbox.get().getDatabase().deallocateConnection();
//
