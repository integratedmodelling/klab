...
public class RasterBufferingInstantiator implements IInstantiator, IExpression {
	...
	public Object eval(IParameters<String> parameters, IComputationContext context) throws KlabException {
		RasterBufferingInstantiator ret = new RasterBufferingInstantiator();
	...
	public List<IObjectArtifact> instantiate(IObservable semantics, IComputationContext context) throws KlabException {
		...
		RenderedImage imtca = GeotoolsUtils.INSTANCE.stateToCoverage(tca, DataBuffer.TYPE_FLOAT, floatNovalue)
				.getRenderedImage();
