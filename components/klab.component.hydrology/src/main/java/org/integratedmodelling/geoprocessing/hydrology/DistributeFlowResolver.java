 ...
 *
 */
public class DistributeFlowResolver implements IResolver<IState>, IExpression {

	private Descriptor exprDescriptor;
	private IContextualizationScope context;
	
	public DistributeFlowResolver() {}

	public DistributeFlowResolver(IParameters<String> parameters, IContextualizationScope context) {
	...
	public Object eval(IParameters<String> parameters, IContextualizationScope context) throws KlabException {
		return new DistributeFlowResolver(parameters, context);
	}
}
