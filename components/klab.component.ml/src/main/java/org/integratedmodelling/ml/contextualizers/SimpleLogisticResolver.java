 ...
 *
 */
public class SimpleLogisticResolver extends AbstractWekaResolver<SimpleLogistic> implements IExpression {

//	private IContextualizationScope context;

	public SimpleLogisticResolver() {
	}

	public SimpleLogisticResolver(IParameters<String> parameters, IContextualizationScope context) {
		super(SimpleLogistic.class, checkDefaults(parameters), context.getTargetSemantics(), true, true, false);
