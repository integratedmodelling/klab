...
import org.integratedmodelling.ml.legacy.riskwiz.learning.data.loader.ArffLoader.ArffReader;
...
public class Instances 
    ...
    public Instances stringFreeStructure() {
        ...
        for (int i = 0; i < atts.size(); i++) {
            ...
            if (att.type() == Attribute.STRING) {
                ...
                atts.setElementAt(
                        new Attribute(att.name(),
                        new Instances(att.relation(), 0)),
                        i);
            }
        }
    ...
    public static Instances mergeInstances(Instances first, Instances second) {
        ...
        Instances merged = new Instances(
                first.relationName() + '_' + second.relationName(), 
                newAttributes, first.numInstances());
        ...
        try {
            ...
            if (empty.classAttribute().isNominal()) {
                ...
                copy.renameAttributeValue(copy.classAttribute(), 
                        copy.classAttribute().value(0), "new_val_name");
            ...
            System.out.print("\nSubset of dataset: ");
            System.out.println(
                    num + " instances from " + (start + 1) + ". instance");
