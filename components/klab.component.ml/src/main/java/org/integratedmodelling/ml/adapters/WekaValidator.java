...
public class WekaValidator implements IResourceValidator {
    ...
    public Builder validate(URL url, IParameters<String> userData, IMonitor monitor) {
        ...
        try {
            ...
            // org.integratedmodelling.klab.components.geospace.extents.Envelope refenv =
            // org.integratedmodelling.klab.components.geospace.extents.Envelope
            ...
            if (!ret.hasErrors()) {
                ...
                // .withSpatialShape((long) grid.getGridRange().getSpan(0), (long)
                // grid.getGridRange().getSpan(1));
                //
