...
package org.integratedmodelling.ml.legacy.riskwiz.learning;
...
public interface IParameterLearner {
    public abstract void learnFromTable(IGraphTable gtable);
    public abstract void learnFromDataSource(IGraphDataSource gtable) throws IOException;
    public abstract void initialize(BeliefNetwork bn);
	
    public abstract BeliefNetwork getFinalResult();
}
