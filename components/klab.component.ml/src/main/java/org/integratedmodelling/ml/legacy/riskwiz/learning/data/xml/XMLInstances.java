...
package org.integratedmodelling.ml.legacy.riskwiz.learning.data.xml;
...
import org.integratedmodelling.ml.legacy.riskwiz.learning.data.Attribute;
import org.integratedmodelling.ml.legacy.riskwiz.learning.data.FastVector;
...
import org.integratedmodelling.ml.legacy.riskwiz.learning.data.ProtectedProperties;
import org.integratedmodelling.ml.legacy.riskwiz.learning.data.SparseInstance;
import org.integratedmodelling.ml.legacy.riskwiz.learning.data.Utils;
 ...
 */
public class XMLInstances extends XMLDocument
    ...
    public final static String DOCTYPE = "<!" + DTD_DOCTYPE + " " + TAG_DATASET
            ...
            + TAG_HEADER + "," + TAG_BODY + ")" + ">\n" + "   <!" + DTD_ATTLIST
            + " " + TAG_DATASET + " " + ATT_NAME + " " + DTD_CDATA + " "
            + DTD_REQUIRED + ">\n" + "   <!" + DTD_ATTLIST + " " + TAG_DATASET
            + " " + ATT_VERSION + " " + DTD_CDATA + " \"" + Version.VERSION
            + "\">\n" + "\n" + "   <!" + DTD_ELEMENT + " " + TAG_HEADER + " ("
            + TAG_NOTES + DTD_OPTIONAL + "," + TAG_ATTRIBUTES + ")" + ">\n"
            + "   <!" + DTD_ELEMENT + " " + TAG_BODY + " (" + TAG_INSTANCES
            + ")" + ">\n" + "   <!" + DTD_ELEMENT + " " + TAG_NOTES + " "
            + DTD_ANY + ">   <!--  comments, information, copyright, etc. -->\n"
            + "\n" + "   <!" + DTD_ELEMENT + " " + TAG_ATTRIBUTES + " ("
            + TAG_ATTRIBUTE + DTD_AT_LEAST_ONE + ")" + ">\n" + "   <!"
            + DTD_ELEMENT + " " + TAG_ATTRIBUTE + " (" + TAG_LABELS
            + DTD_OPTIONAL + "," + TAG_METADATA + DTD_OPTIONAL + ","
            + TAG_ATTRIBUTES + DTD_OPTIONAL + ")" + ">\n" + "   <!"
            + DTD_ATTLIST + " " + TAG_ATTRIBUTE + " " + ATT_NAME + " "
            + DTD_CDATA + " " + DTD_REQUIRED + ">\n" + "   <!" + DTD_ATTLIST
            + " " + TAG_ATTRIBUTE + " " + ATT_TYPE + " (" + VAL_NUMERIC
            + DTD_SEPARATOR + VAL_DATE + DTD_SEPARATOR + VAL_NOMINAL
            + DTD_SEPARATOR + VAL_STRING + DTD_SEPARATOR + VAL_RELATIONAL + ") "
            + DTD_REQUIRED + ">\n" + "   <!" + DTD_ATTLIST + " " + TAG_ATTRIBUTE
            + " " + ATT_FORMAT + " " + DTD_CDATA + " " + DTD_IMPLIED + ">\n"
            + "   <!" + DTD_ATTLIST + " " + TAG_ATTRIBUTE + " " + ATT_CLASS
            ...
            + ">\n" + "   <!" + DTD_ATTLIST + " " + TAG_PROPERTY + " "
            + ATT_NAME + " " + DTD_CDATA + " " + DTD_REQUIRED + ">\n" + "\n"
            + "   <!" + DTD_ELEMENT + " " + TAG_INSTANCES + " (" + TAG_INSTANCE
            + DTD_ZERO_OR_MORE + ")" + ">\n" + "   <!" + DTD_ELEMENT + " "
            + TAG_INSTANCE + " (" + TAG_VALUE + DTD_ZERO_OR_MORE + ")" + ">\n"
            + "   <!" + DTD_ATTLIST + " " + TAG_INSTANCE + " " + ATT_TYPE + " ("
            + VAL_NORMAL + DTD_SEPARATOR + VAL_SPARSE + ") \"" + VAL_NORMAL
            + "\"" + ">\n" + "   <!" + DTD_ATTLIST + " " + TAG_INSTANCE + " "
            + ATT_WEIGHT + " " + DTD_CDATA + " " + DTD_IMPLIED + ">\n" + "   <!"
            + DTD_ELEMENT + " " + TAG_VALUE + " (" + DTD_PCDATA + DTD_SEPARATOR
            + TAG_INSTANCES + ")" + DTD_ZERO_OR_MORE + ">\n" + "   <!"
            + DTD_ATTLIST + " " + TAG_VALUE + " " + ATT_INDEX + " " + DTD_CDATA
            + " " + DTD_IMPLIED
    ...
    protected void addAttribute(Element parent, Attribute att) {
        ...
        if (att.isNominal()) {
            ...
            while (enm.hasMoreElements()) {
                ...
                label.appendChild(
                        m_Document.createTextNode(validContent(tmpStr)));
            }
        }
        ...
        if ((att.getMetadata() != null) && (att.getMetadata().size() > 0)) {
            ...
            while (enm.hasMoreElements()) {
                ...
                property.appendChild(
                        m_Document.createTextNode(
                                validContent(
                                        att.getMetadata().getProperty(tmpStr, ""))));
            }
        }
            ...
            if (inst.isMissing(index)) {
                ...
                if (inst.attribute(index).isRelationValued()) {
                    ...
                    if (inst.attribute(index).type() == Attribute.NUMERIC) {
                        value.appendChild(
                                m_Document.createTextNode(
                                        Utils.doubleToString(inst.value(index),
                                        m_Precision)));
                    } else {
                        value.appendChild(
                                m_Document.createTextNode(
                                        validContent(inst.stringValue(index))));
                    }
                }
            }
