...
import org.integratedmodelling.ml.legacy.riskwiz.influence.jensen.PolicyNetworkJoinTree;
import org.integratedmodelling.ml.legacy.riskwiz.influence.jensen.StrongJoinTree;
...
public class JTSolverPN extends JTSolver<StrongJoinTree> {
    ...
    public JTInferencePN getPolicyNetworkInference() {
        PolicyNetworkJoinTree pjtree = new PolicyNetworkJoinTree(jTree);

        return new JTInferencePN(pjtree);
    }
