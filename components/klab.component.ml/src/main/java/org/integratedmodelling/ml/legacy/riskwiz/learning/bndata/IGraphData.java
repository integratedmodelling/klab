...
public interface IGraphData {
    public abstract void connect(BeliefNetwork bn);
    public abstract Vector<String> getScheme();
    public abstract int[] getQuery(BNNode node, Vector<String> tupleValues);
    public abstract boolean hasCompleteProjection(BNNode node);
}
