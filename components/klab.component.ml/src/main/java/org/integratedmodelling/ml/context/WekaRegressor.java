...
public class WekaRegressor {
    ...
    public WekaRegressor(Classifier cls, WekaOptions options, boolean predictionIsProbabilistic) {
        this.classifier = cls;
    ...
    public WekaRegressor(Class<? extends Classifier> cls, WekaOptions options, boolean predictionIsProbabilistic) {
    ...
    public WekaRegressor(File localFile, boolean predictionIsProbabilistic) {
        try {
    ...
    public WekaRegressor(File importFile, String classifierClass, boolean predictionIsProbabilistic) {
        try {
