 ...
 * 
 */
public class GenieReader {

    /**
     * 
     */
    public GenieReader() {// TODO Auto-generated constructor stub
    }
    ...
    public BeliefNetwork loadFromFile(String name) throws FileNotFoundException {
            ...
            case Node.ELEMENT_NODE:
                ...
                if (name.equals("parents")) { // $NON-NLS-1$
                    ...
                    ParamString = getElementValue(node);
                        ...
                        && !name.equals("strengths") && Setting.DEBUG) {  
                    System.out.println("Unhandled variable element " + name);
                }
                break;
