...
package org.integratedmodelling.ml.legacy.riskwiz.learning.data;
...
public class SparseInstance extends Instance {
	...
	public Instance mergeInstance(Instance inst) {
        ...
        return new SparseInstance(1.0, values, indices,
	...
	public void setValueSparse(int indexOfIndex, double value) {
        ...
        if (value != 0) {
            ...
            System.arraycopy(m_AttValues, indexOfIndex + 1, tempValues,
                    indexOfIndex, m_AttValues.length - indexOfIndex - 1);
            System.arraycopy(m_Indices, indexOfIndex + 1, tempIndices,
                    indexOfIndex, m_Indices.length - indexOfIndex - 1);
            m_AttValues = tempValues;
            m_Indices = tempIndices;
        }
    }
                    ...
                    if (m_Dataset.attribute(m_Indices[i]).isNominal()
                        ...
                        try {
                            text.append(
                                    m_Indices[i] + " "
                                    + Utils.quote(
                                            m_Dataset.attribute(m_Indices[i]).relation((int) valueSparse(i)).stringWithoutHeader()));
                        } catch (Exception e) {
                            e.printStackTrace();
                            System.err.println(new Instances(m_Dataset, 0));
                            System.err.println(
    ...
    public static void main(String[] options) {
        ...
        try {
            ...
            System.out.println(
                    "Class value (internal format): " + inst.classValue());
            ...
            System.out.println(
                    "Header of original and copy equivalent: "
                            + inst.equalHeaders(copy));

            // Test for missing values
            System.out.println(
                    "Length of copy missing: " + copy.isMissing(length));
            System.out.println(
                    "Weight of copy missing: " + copy.isMissing(weight.index()));
            System.out.println(
                    "Length of copy missing: "
                            + Instance.isMissingValue(copy.value(length)));
            System.out.println(
                    "Missing value coded as: " + Instance.missingValue());
            ...
            System.out.println(
                    "Copy with class value set to first value: " + copy);
            ...
            System.out.println(
                    "Copy with last attribute set to \"first\": " + copy);
            System.out.println(
                    "Current weight of instance copy: " + copy.weight());
            copy.setWeight(2);
            System.out.println(
                    "Current weight of instance copy (set to 2): "
                            + copy.weight());
            System.out.println("Last value of copy: " + copy.toString(2));
            System.out.println(
                    "Value of position for copy: " + copy.toString(position));
            System.out.println(
                    "Last value of copy (internal format): " + copy.value(2));
            System.out.println(
