...
//				return new ArrayFloat.D7(dimensions[0], dimensions[1], dimensions[2], dimensions[3], dimensions[4],
...
//				return new ArrayByte.D7(dimensions[0], dimensions[1], dimensions[2], dimensions[3], dimensions[4],
//						dimensions[5], dimensions[6], false);
//			} else if (varDataType == DataType.SHORT) {
//				return new ArrayShort.D7(dimensions[0], dimensions[1], dimensions[2], dimensions[3], dimensions[4],
//						dimensions[5], dimensions[6], false);
//			} else if (varDataType == DataType.INT) {
//				return new ArrayInt.D7(dimensions[0], dimensions[1], dimensions[2], dimensions[3], dimensions[4],
//						dimensions[5], dimensions[6], false);
//			} else
...
//						dimensions[5]);
//			} else if (varDataType == DataType.BYTE) {
//				return new ArrayByte.D6(dimensions[0], dimensions[1], dimensions[2], dimensions[3], dimensions[4],
//						dimensions[5], false);
//			} else if (varDataType == DataType.SHORT) {
//				return new ArrayShort.D6(dimensions[0], dimensions[1], dimensions[2], dimensions[3], dimensions[4],
//						dimensions[5], false);
//			} else if (varDataType == DataType.INT) {
//				return new ArrayInt.D6(dimensions[0], dimensions[1], dimensions[2], dimensions[3], dimensions[4],
//						dimensions[5], false);
//			} else
//				throw new IllegalArgumentException("unsupported Datatype");
//		case 5:
