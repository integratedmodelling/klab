...
public class NetCDFUtils {
	...
	// * of the variable. This is the value returned by the default implementation
	// of
	...
	// public static NetcdfDataset acquireFeatureCollection(String path) throws
	// IOException {
	// Formatter formatter = new Formatter(System.err);
	// FeatureCollectionConfigBuilder builder = new
	// FeatureCollectionConfigBuilder(formatter);
	...
	// return new ArrayFloat.D7(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5], dimensions[6]);
	// } else if (varDataType == DataType.DOUBLE) {
	// return new ArrayDouble.D7(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5], dimensions[6]);
	// } else if (varDataType == DataType.BYTE) {
	// return new ArrayByte.D7(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5], dimensions[6], false);
	// } else if (varDataType == DataType.SHORT) {
	// return new ArrayShort.D7(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5], dimensions[6], false);
	// } else if (varDataType == DataType.INT) {
	// return new ArrayInt.D7(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5], dimensions[6], false);
	// } else
	...
	// // 6D Arrays
	// if (varDataType == DataType.FLOAT) {
	// return new ArrayFloat.D6(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5]);
	// } else if (varDataType == DataType.DOUBLE) {
	// return new ArrayDouble.D6(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5]);
	// } else if (varDataType == DataType.BYTE) {
	// return new ArrayByte.D6(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5], false);
	// } else if (varDataType == DataType.SHORT) {
	// return new ArrayShort.D6(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5], false);
	// } else if (varDataType == DataType.INT) {
	// return new ArrayInt.D6(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// dimensions[5], false);
	// } else
	...
	// // 5D Arrays
	// if (varDataType == DataType.FLOAT) {
	// return new ArrayFloat.D5(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4]);
	// } else if (varDataType == DataType.DOUBLE) {
	// return new ArrayDouble.D5(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4]);
	// } else if (varDataType == DataType.BYTE) {
	// return new ArrayByte.D5(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// false);
	// } else if (varDataType == DataType.SHORT) {
	// return new ArrayShort.D5(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// false);
	// } else if (varDataType == DataType.INT) {
	// return new ArrayInt.D5(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3],
	// dimensions[4],
	// false);
	// } else
	...
	// // 4D Arrays
	// if (varDataType == DataType.FLOAT) {
	// return new ArrayFloat.D4(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3]);
	// } else if (varDataType == DataType.DOUBLE) {
	// return new ArrayDouble.D4(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3]);
	// } else if (varDataType == DataType.BYTE) {
	// return new ArrayByte.D4(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3], false);
	// } else if (varDataType == DataType.SHORT) {
	// return new ArrayShort.D4(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3], false);
	// } else if (varDataType == DataType.INT) {
	// return new ArrayInt.D4(dimensions[0], dimensions[1], dimensions[2],
	// dimensions[3], false);
	// } else
	// throw new IllegalArgumentException("unsupported Datatype");
	// case 3:
	...
	// }
	// throw new IllegalArgumentException(
	// "Unable to create a proper array unsupported Datatype; nDims not between 1
	// and 7");
	// }
	...
	// * "Variables" are defined as those that have a 2-dimensional shape, i.e.
	// grids.
	// * All 1-dimensional variables are copied as they are. This only supports
	// * aggregation of 2d grids defined over 1d dimensions, and the dimensions in
	// the
	// * output file will be the same as those of the first file aggregated, for now
	// * including time which should actually reflect the aggregation period.
	// Limited
	...
	// */
	// public static String aggregateFiles(List<File> toAggregate, File
	// destinationFile, Resolution
	// resolution,
	...
	//
	// /*
	// * if it's just one file, extract the first grid name, copy the file and
	// return
	// */
	...
	// */
	// outfile.addVariable(v.getFullName(), v.getDataType(),
	// v.getDimensionsString());
	// Variable.Builder<?> varbuilder = outfile.addVariable(v.getFullName(),
	// v.getDataType(),
	// v.getDimensionsString());
	...
	// first = false;
	//
	// System.out.println("Done " + (nfile++) + "/" + toAggregate.size() + ": " +
	// infile);
	//
	// }
	//
