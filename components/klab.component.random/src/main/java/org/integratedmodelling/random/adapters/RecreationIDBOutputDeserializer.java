...
public class RecreationIDBOutputDeserializer {
	...
	static public class RecreationAreas {
		...
		// TODO: there's more potentially interesting information that is not gathered
		// for the time being. Only gathering coordinates, id and name.
		public Collection<AreaData> areas;

		@JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
		public RecreationAreas(@JsonProperty("RECDATA") Collection<AreaData> areas) {
			this.areas = areas;
		}
		...
		public static class AreaData {
			...
			@JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
			public AreaData(@JsonProperty("RecAreaLatitude") double lat, @JsonProperty("RecAreaLongitude") double lon,
					@JsonProperty("RecAreaID") String id, @JsonProperty("RecAreaName") String name) {
				this.lat = lat;
				this.lon = lon;
				this.id = id;
				this.name = name;
