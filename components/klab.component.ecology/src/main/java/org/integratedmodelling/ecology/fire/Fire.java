package org.integratedmodelling.ecology.fire;
...
/**
 * Very basic CA fire model (http://rosettacode.org/wiki/Forest_fire#Java). Likely 
 * ridicolously simple and inadequate for anything.
 * 
 * @author ferdinando.villa (not really).
 *
 */
public class Fire {
    ...
    public static void main(String[] args) {
        List<String> land = Arrays
                .asList(".TTT.T.T.TTTT.T", "T.T.T.TT..T.T..", "TT.TTTT...T.TT.", "TTT..TTTTT.T..T", ".T.TTT....TT.TT", "...T..TTT.TT.T.", ".TT.TT...TT..TT", ".TT.T.T..T.T.T.", "..TTT.TT.T..T..", ".T....T.....TTT", "T..TTT..T..T...", "TTT....TTTTTT.T", "......TwTTT...T", "..T....TTTTTTTT", ".T.T.T....TT...");
        print(land);
