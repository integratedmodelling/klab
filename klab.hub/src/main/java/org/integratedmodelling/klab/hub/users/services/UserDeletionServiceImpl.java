...
import org.integratedmodelling.klab.hub.ldap.commands.DeleteLdapUser;
...
public class UserDeletionServiceImpl implements UserDeletionService{
	...
	public UserDeletionServiceImpl(UserRepository userRepository, LdapUserDetailsManager ldapUserDetailsManager, TaskMongoTemplate taskMongoTemplate, AgreementMongoTemplate agreementMongoTemplate, TokenRepository tokenRepository) {
		super();
	...
	public void deleteUser(String username) {
		...
		try {
			...
			agreementMongoTemplate.removeAgreementsById(user.getAgreements().stream().map(agreement -> agreement.getAgreement().getId()).toList());
