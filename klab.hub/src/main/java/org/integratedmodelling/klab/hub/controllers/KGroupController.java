...
public class KGroupController {
	...
	public ResponseEntity<Object> getGroups() {
		return new ResponseEntity<>(mongoGroupService.getGroups(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getGroupNames() {
		...
		resp.appendField("Groups", mongoGroupService.getGroupNames());
	...
	public ResponseEntity<Object> updateGroup(@PathVariable("id") String id, @RequestBody MongoGroup group) {
		mongoGroupService.updateGroup(id, group);
	...
	public ResponseEntity<Object> delete(@PathVariable("id") String id) {
		mongoGroupService.deleteGroup(id);
	...
	public ResponseEntity<Object> getGroup(@PathVariable("id") String id) {
		MongoGroup group = mongoGroupService.getGroup(id).orElseThrow(() -> new BadRequestException("No group by that name found"));
	...
	public ResponseEntity<Object> createGroup(@RequestBody MongoGroup group) {
		mongoGroupService.createGroup(group.getId(), group);
