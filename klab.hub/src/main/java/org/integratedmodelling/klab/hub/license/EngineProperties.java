...
public class EngineProperties implements IProperties {
	...
	public EngineProperties(User user, LicenseConfiguration config) {
		super();
		...
		this.properties.setProperty(KlabCertificate.KEY_USERNAME, user.getUsername());
		this.properties.setProperty(KlabCertificate.KEY_EMAIL, user.getEmail());
