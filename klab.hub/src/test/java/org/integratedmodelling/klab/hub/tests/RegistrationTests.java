...
import org.integratedmodelling.klab.hub.users.payload.PasswordChangeRequest;
...
public class RegistrationTests extends ApplicationCheck {
    ...
    public void pass_create_new_user() throws URISyntaxException, MalformedURLException, FolderException {
        ...
        URL s = null; // this is a url because the string is annoying to grep i cant get the carrige
                      // return
        ...
        ResponseEntity<JSONObject> newPasswordrequest = restTemplate.postForEntity(newPassword, passwordRequest,
                JSONObject.class);
    ...
    public void fail_lost_passwordd_token_() throws URISyntaxException {
        ...
        URI newPassword = new URIBuilder(baseUrl.concat("/" + username)).addParameter(API.HUB.PARAMETERS.USER_LOST_PASSWORD, "")
                .build();
    ...
    public void pass_lost_passwordd_token() throws URISyntaxException, FolderException, MalformedURLException {
        ...
        ResponseEntity<JSONObject> newPasswordrequest = restTemplate.postForEntity(setNewPassword, passwordRequest,
                JSONObject.class);
