...
public interface IObservation extends IObservationIdentity, Serializable {
    ...
    /**
     * The subject observation that contextualized this observation. This is not the same as the context
     * observation: it allows recording different viewpoints on observations that are contextual to the same
     * observable - e.g. qualities of the same subject seen by different child subjects in it. If null, this
     * was made by the "root subject" that represents the session user. Later we may create a subject to
     * represent the session user.
     * 
     * @return the subject that provides the viewpoint for this observation, or null if this was a user-made
     *         observation.
     */
    ...
    /**
     * Observation may have been made in the context of another direct observation. This will always return
     * non-null in indirect observations, and may return null in direct ones when they represent the "root"
     * context.
     * 
    ...
    /**
     * The topmost ISubject that acts as a context for everything. This subject's getRoot() will return null.
     * 
