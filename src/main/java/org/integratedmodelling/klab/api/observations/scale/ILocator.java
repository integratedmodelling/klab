 ...
 * 
 * This is an opaque interface and behaving correctly when used is left to the implementation. Locators
 * are used for example to {@link IState#getValue(ILocator) retrieve or set values from states}.
 * 
 * @author Ferd
 *
 */
public interface ILocator {
   ...
   * any extent exists.
   */
  public static final ILocator INITIALIZATION = new ILocator() {};
