 ...
 * {@link #setRuntimeContext(IActuator, Artifact, IMonitor)} is called. Default abstract implementations should
 * be provided that implement the {@link #createObservation(IScale)} function.
 * 
