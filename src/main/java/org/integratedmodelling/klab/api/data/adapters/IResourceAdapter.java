 ...
 * must be annotated with a {@link ResourceAdapter} annotation in order to be
 * discovered by the runtime.
 * 
 * The implementing class may specify initialization and finalization methods by
 * annotating them with the {@link Initialize} and {@link Shutdown} annotations
 * also used for components.
 * 
 * @author Ferd
 *
 */
