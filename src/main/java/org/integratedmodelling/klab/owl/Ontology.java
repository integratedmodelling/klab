...
public class Ontology implements IOntology {
    ...
    public void addDelegateConcept(String id, IKimNamespace namespace, IConcept concept) {
                ...
                if (axiom.is(IAxiom.CLASS_ASSERTION)) {
                    ...
                    if (target != null) {
                        ...
                        if (value instanceof String)
                            literal = factory
                                    .getOWLLiteral(StringUtils.pack((String) value));
