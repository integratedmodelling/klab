...
public class Scale implements IScale {
  ...
  public final Index getIndex(int sliceIndex, int sliceNumber, Locator... locators) {
    ...
    return new ScaleIndex(
        Scale.this.cursor.getDimensionScanner(variableDimension, exts, sliceIndex, sliceNumber),
        variableDimension);
  }
  ...
  public final Index getIndex(Locator... locators) {
    ...
    return new ScaleIndex(Scale.this.cursor.getDimensionScanner(variableDimension, exts),
        variableDimension);
  }
