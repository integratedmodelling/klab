...
public class Event extends CountableObservation implements IEvent {
  ...
  private Event(String name, Observable observable, Scale scale, Subject context, IMonitor monitor) {
  ...
  public static Event create(String name, Observable observable, Scale scale, Subject context, IMonitor monitor) {
    return new Event(name, observable, scale, context, monitor);
  }
