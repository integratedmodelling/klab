...
public class CoreOntology extends AbstractWorkspace {
  ...
  public static interface NS {
    ...
    public static final String BASE_DECLARATION                        =
        "observation:baseDeclaration";
    ...
    public static final String HAS_COMPRESENT_PROPERTY                 =
        "observation:hasCompresent";
    ...
    public static final String HAS_SUBJECTIVE_TRAIT_PROPERTY           =
        "observation:hasSubjectiveTrait";
    public static final String IS_SUBJECTIVE                           =
        "observation:isSubjectiveTrait";
    ...
    public static final String IMPLIES_OBSERVABLE_PROPERTY             =
        "observation:impliesObservable";
    ...
    public static final String IMPLIES_SOURCE_PROPERTY                 =
        "observation:impliesSource";
    public static final String IMPLIES_DESTINATION_PROPERTY            =
        "observation:impliesDestination";
    public static final String CONFERS_TRAIT_PROPERTY                  = "observation:confersTrait";
    public static final String DESCRIBES_QUALITY_PROPERTY              =
        "observation:describesQuality";
    public static final String PROPORTIONAL_QUALITY_PROPERTY           =
        "observation:proportionalQuality";
    public static final String INVERSELY_PROPORTIONAL_QUALITY_PROPERTY =
        "observation:inverselyProportionalQuality";
    public static final String CLASSIFIES_QUALITY_PROPERTY             =
        "observation:classifiesQuality";
    public static final String DISCRETIZES_QUALITY_PROPERTY            =
        "observation:discretizesQuality";
    ...
    public static final String REPRESENTED_BY_PROPERTY                 =
        "observation:representedBy";
    public static final String IS_TYPE_DELEGATE                        =
        "observation:isTypeDelegate";

    // core observation ontology
    public static final String OBSERVATION                             = "observation:Observation";
    public static final String DIRECT_OBSERVATION                      =
        "observation:DirectObservation";
    public static final String INDIRECT_OBSERVATION                    =
        "observation:IndirectObservation";
    public static final String CLASSIFICATION                          =
        "observation:Classification";
    public static final String MEASUREMENT                             = "observation:Measurement";
    public static final String QUANTIFICATION                          =
        "observation:Quantification";
    public static final String RANKING                                 = "observation:Ranking";
    public static final String COUNT_OBSERVATION                       =
        "observation:CountObservation";
    public static final String PERCENTAGE_OBSERVATION                  =
        "observation:PercentageObservation";
    public static final String PROPORTION_OBSERVATION                  =
        "observation:ProportionObservation";
    public static final String RATIO_OBSERVATION                       =
        "observation:RatioObservation";
    public static final String DISTANCE_OBSERVATION                    =
        "observation:DistanceMeasurement";
    public static final String VALUE_OBSERVATION                       = "observation:Valuation";
    public static final String PROBABILITY_OBSERVATION                 =
        "observation:ProbabilityObservation";
    public static final String UNCERTAINTY_OBSERVATION                 =
        "observation:UncertaintyObservation";
    public static final String PRESENCE_OBSERVATION                    =
    ...
    public static final String SUBJECTIVE_CONCORDANCE                  =
    ...
    public static final String SUBJECT_CONTEXTUALIZER                  =
        "klab:SubjectContextualizer";
    public static final String PROCESS_CONTEXTUALIZER                  =
        "klab:ProcessContextualizer";
    ...
    public static final String RELATIONSHIP_INSTANTIATOR               =
        "klab:RelationshipInstantiator";
    public static final String FUNCTIONAL_RELATIONSHIP_CONTEXTUALIZER  =
        "klab:FunctionalRelationshipContextualizer";
    public static final String STRUCTURAL_RELATIONSHIP_CONTEXTUALIZER  =
        "klab:StructuralRelationshipContextualizer";
    ...
    public static final String UNTRANSFORMED_CONCEPT_PROPERTY          =
        "klab:untransformedConceptId";
     ...
     */
    public static final String CONTEXTUALIZES                          =
        "observation:contextualizes";
    ...
    public static final String CONSTITUENT_OF                          =
        "observation:isConstituentOf";
    public static final String STRUCTURING_PROPERTY                    =
        "observation:structuringObjectProperty";
    ...
    public static final String CONTAINS_PART_SPATIALLY_PROPERTY        =
        "observation:containsPartSpatially";
    ...
    public static final String CORE_OBJECT                             =
        "observation:DirectObservable";
    ...
    public static final String CORE_QUANTITY                           =
        "observation:ContinuousNumericallyQuantifiableQuality";
    public static final String CORE_ASSERTED_QUALITY                   =
        "observation:AssertedQuality";
    public static final String CORE_SUBJECT                            = "observation:Subject";
    public static final String CORE_PHYSICAL_OBJECT                    =
        "observation:PhysicalObject";
    public static final String CORE_PHYSICAL_PROPERTY                  =
        "observation:PhysicalProperty";
    public static final String CORE_EXTENSIVE_PHYSICAL_PROPERTY        =
        "observation:ExtensivePhysicalProperty";
    public static final String CORE_INTENSIVE_PHYSICAL_PROPERTY        =
    ...
    public static final String CORE_RELATIVE_QUANTITY                  =
        "observation:RelativeQuantity";
    ...
    public static final String CORE_MONETARY_VALUE                     =
        "observation:MonetaryValue";
    public static final String CORE_PREFERENCE_VALUE                   =
        "observation:PreferenceValue";
    ...
    public static final String CORE_ELECTRIC_POTENTIAL                 =
        "observation:ElectricPotential";
    ...
    public static final String CORE_CONFIGURATION                      =
        "observation:Configuration";
    public static final String CORE_RELATIONSHIP                       = "observation:Relationship";
    public static final String CORE_FUNCTIONAL_RELATIONSHIP            =
        "observation:FunctionalRelationship";
    public static final String CORE_STRUCTURAL_RELATIONSHIP            =
        "observation:StructuralRelationship";
    ...
    public static final String CORE_REACTIVE_AGENT                     =
        "observation:ReactiveAgent";
    public static final String CORE_DELIBERATIVE_AGENT                 =
        "observation:DeliberativeAgent";
    public static final String CORE_INTERACTIVE_AGENT                  =
        "observation:InteractiveAgent";
    public static final String CORE_UNCERTAINTY                        = "observation:Uncertainty";
    public static final String CORE_OBSERVABILITY_TRAIT                =
  ...
  public void registerCoreConcept(String coreConcept, IConcept worldviewPeer) {
    /*
     * TODO must handle the specialized concepts so that they inherit from the redefined ones, too.
     * E.g. when the AGENT handler is received, it should create and install all the agent types in
     * the same ontology.
     */
  }
  ...
  public List<INamespace> load(boolean incremental, IMonitor monitor) throws KlabException {
     ...
     * which makes the validator stop silently (by XText design) and ignore everything beyond the
     * first delay.
     * 
     * DO NOT REMOVE this test. Removing it will cause seemingly completely unrelated bugs that will
     * take a very long time to figure out.
     */
  ...
  public Type getRepresentativeCoreType(Set<Type> type) {
    ...
    /*
     * FIXME can be made faster using a mask and a switch, although the specialized concepts still
     * require a bit of extra logic.
     */
