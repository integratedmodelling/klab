 ...
 * k.LAB languages support Java-style annotations) but it can also be used for other purposes. All
 * k.LAB services must be able to serialize it properly. It's essentially a named
 * {@link KParameters} object with a name; a content class attribute is also added to capture typed
 * objects like in k.IM's <code>define</code> statements. Does not preserve the relationship with
 * the k.IM, k.DL or k.Actors statement after construction.
 * 
 * @author Ferd
 *
 */
