 ...
 * {@link KContextualizable}s that <em>produce</em> knowledge or
 * {@link KArtifact} that organize it and make it available for successive
 ...
 * is attributed to Agents, which may be {@link KUserIdentity} or the AI in
 * k.LAB (for attribution of tasks and acknowledgements) or {@link KModel
 ...
 * <p>
 * Any {@link KResource}s used by models (data or computations) come with
...
public interface KProvenance {
	 ...
	 */
	List<KActivity> getPrimaryActions();
	 ...
	 */
	Collection<KArtifact> getArtifacts();
