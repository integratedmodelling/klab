...
import org.integratedmodelling.klab.api.knowledge.KObjectArtifact;
 ...
 * @version $Id: $Id
 */
public abstract interface KDirectObservation extends KObservation, KObjectArtifact {
	 ...
	 * @return
	 */
	KObservation getChildObservation(KObservable observable);
	 ...
	 */
	Collection<KState> getStates();

	@Override
	KDirectObservation at(KLocator locator);
	 ...
	 * @return
	 */
	KPattern getOriginatingPattern();
