...
import org.integratedmodelling.klab.api.knowledge.KDataArtifact;

/**
 * A {@link org.integratedmodelling.klab.api.KState.IState} is the semantic
 * {@link org.integratedmodelling.klab.api.KObservation.IObservation} that specializes a
 * non-semantic {@link KDataArtifact data artifact}. Its {@link #getObservable() observable} is
 * always a quality.
 * <p>
 *
 ...
 * @version $Id: $Id
 */
public interface KState extends KObservation, KDataArtifact {
     ...
     */
    <T> Iterator<T> iterator(KLocator index, Class<? extends T> cls);
     ...
     */
    KState in(KValueMediator mediator);

    @Override
    KState at(KLocator locator);
...
//    ISubjectiveState reinterpret(IDirectObservation observer);
     ...
     */
    Object aggregate(KLocator... locators);
