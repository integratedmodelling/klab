...
import org.integratedmodelling.klab.api.data.mediation.classification.IClassification;
import org.integratedmodelling.klab.api.data.mediation.classification.ILookupTable;
...
import org.integratedmodelling.klab.api.services.runtime.INotification.Mode;
 ...
 *
 */
public interface IContextualizable extends IProvenance.Node {
...
//	IKimAction.Trigger getTrigger();
	 ...
	 */
	IContextualizable contextualize(IArtifact target, IContextScope scope);
