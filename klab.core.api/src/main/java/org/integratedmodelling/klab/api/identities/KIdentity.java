 ...
 * {@link KUserIdentity}. Nodes and engines start by reading a certificate, which establishes the
 ...
 * as a {@link KEngine}, then duplicate the {@link KUserIdentity} as the default
 * {@link IEngineUserIdentity}, to which they can add others if local authentication is enabled.
 * {@link ISession Sessions} are appended to each IEngineUser, {@link KObservation observations} to
 ...
 * @version $Id: $Id
 */
public abstract interface KIdentity {
     ...
     *
     * @return a {@link org.integratedmodelling.klab.api.KIdentity.IIdentity} object.
     */
    KIdentity getParentIdentity();

    /**
     * True if the identity is of the passed type.
     *
     * @param type a {@link org.integratedmodelling.klab.api.KIdentity.IIdentity.Type} object.
     * @return a boolean.
     */
     ...
     * @param <T> a T object.
     */
    <T extends KIdentity> T getParentIdentity(Class<T> type);
    ...
    static <T extends KIdentity> T findParent(KIdentity child, Class<T> type) {
        return child == null
                ? null
