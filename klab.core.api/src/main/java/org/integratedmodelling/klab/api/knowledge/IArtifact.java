...
import org.integratedmodelling.klab.api.knowledge.observation.IProcess;
import org.integratedmodelling.klab.api.knowledge.observation.ISubject;
import org.integratedmodelling.klab.api.knowledge.observation.scale.time.ITime;
import org.integratedmodelling.klab.api.lang.IAnnotation;
...
public interface IArtifact extends IProvenance.Node, Iterable<IArtifact> {
    ...
    interface Structure {
         ...
         * @return
         */
        IIdentity getObserver(IArtifact artifact);
