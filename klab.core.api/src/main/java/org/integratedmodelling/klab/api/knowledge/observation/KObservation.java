 ...
 * @version $Id: $Id
 */
public interface KObservation extends KIdentity, KArtifact {
	 ...
	 * {@link org.integratedmodelling.klab.api.provenance.KArtifact#getGeometry()}
	 * as a {@link org.integratedmodelling.klab.api.KScale.scale.IScale} is a
	 * {@link org.integratedmodelling.klab.api.data.KGeometry}, and in a standard
	 * implementation should do just that, but a
	 * {@link org.integratedmodelling.klab.api.KScale.scale.IScale} is
	 ...
	 *                                  observation
	 */
	KObservation at(KLocator locator);
	 ...
	 */
	KDirectObservation getRootContext();
	 ...
	 * {@link KArtifact#getTimestamp()}; otherwise it is the time reported by the
