 ...
 * </pre>
 * 
 * where the {@link KGeometry geometry} specs before @ and the @ character itself are optional if
...
public interface KLocator extends Iterable<KLocator> {
     ...
     * @return
     */
    <T extends KLocator> T as(Class<T> cls);
