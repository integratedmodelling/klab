...
public interface IParameters<T> extends Map<T, Object> {
     ...
     * @return
     */
    IParameters<T> with(IParameters<String> templateVariables);

    /**
     * If {@link #with(IParameters)} has been called, return the variables, otherwise return null.
     * 
     * @return
     */
    IParameters<String> getTemplateVariables();
