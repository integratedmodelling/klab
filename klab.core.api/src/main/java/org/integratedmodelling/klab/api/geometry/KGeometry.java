 ...
 * {@link KPrototype#getGeometry() service prototype} declared in KDL). When used in such a
 ...
 * 
 */
public interface KGeometry extends Serializable, KLocator {
    ...
    public interface Dimension extends Serializable {
        ...
        /**
         * Can be {@link KGeometry#NONDIMENSIONAL} or a positive (0+) integer. Non-dimensional means
         ...
         * {@link KGeometry#UNDEFINED}, which is a negative value.
         * 
         ...
         * {@link KGeometry#UNDEFINED} values of size corresponding to the dimensionality.
         * 
         * @param dimension
     ...
     * <p>
     * Locators can be converted to the desired form using {@link KLocator#as(Class)}. So if numeric
