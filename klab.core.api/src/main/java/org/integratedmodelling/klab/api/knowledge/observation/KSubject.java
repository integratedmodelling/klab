 ...
 * {@link org.integratedmodelling.klab.api.KObservation.IObservation} API. Only subjects can have
 ...
 * @version $Id: $Id
 */
public interface KSubject extends KDirectObservation {
     ...
     * @return a {@link java.util.Collection} object.
     */
    Collection<KProcess> getProcesses();
     ...
     * @return a {@link java.util.Collection} object.
     */
    Collection<KSubject> getSubjects();
     ...
     * @return a {@link java.util.Collection} object.
     */
    Collection<KRelationship> getRelationships();
     ...
     * </p>
     *
     * @param subject a {@link org.integratedmodelling.klab.api.KSubject.ISubject} object.
     * @return a {@link java.util.Collection} object.
     */
    Collection<KRelationship> getIncomingRelationships(KSubject subject);
     ...
     * @return a {@link java.util.Collection} object.
     */
    Collection<KRelationship> getOutgoingRelationships(KSubject subject);
     ...
     */
    Map<KConcept, KConfiguration> getConfigurations();
//
//    /**
