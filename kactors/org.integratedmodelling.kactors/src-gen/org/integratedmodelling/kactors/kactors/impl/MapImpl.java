 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kactors.kactors.impl.MapImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapImpl extends MinimalEObjectImpl.Container implements Map
{
  ...
  {
    return KactorsPackage.Literals.MAP;
  }
  ...
  public EList<MapEntry> getEntries()
  {
    if (entries == null)
    {
      entries = new EObjectContainmentEList<MapEntry>(MapEntry.class, this, KactorsPackage.MAP__ENTRIES);
    }
    return entries;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KactorsPackage.MAP__ENTRIES:
