...
public class BodyImpl extends MinimalEObjectImpl.Container implements Body
{
  ...
  public EList<Statement> getList()
  {
    if (list == null)
    {
      list = new EObjectContainmentEList<Statement>(Statement.class, this, KactorsPackage.BODY__LIST);
    }
    return list;
  }
  ...
  public void setIsgroup(boolean newIsgroup)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KactorsPackage.BODY__ISGROUP, oldIsgroup, isgroup));
  }
