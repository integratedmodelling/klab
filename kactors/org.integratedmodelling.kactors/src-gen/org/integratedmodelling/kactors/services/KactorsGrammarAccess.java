...
public class KactorsGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class PreambleElements extends AbstractParserRuleElementFinder {
		...
		//public?='public'? (mobile?='mobile' | desktop?='desktop' | web?='web')? app?='app' | test?='testcase' | script?='script'
		//| task?='task' | component?='component' | user?='user' | library?=('trait' | 'library') | behavior?=('behavior' |
		//'behaviour')
