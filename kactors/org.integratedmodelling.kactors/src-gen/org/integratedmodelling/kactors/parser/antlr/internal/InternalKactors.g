				...
				{getUnorderedGroupHelper().canSelect(grammarAccess.getPreambleAccess().getUnorderedGroup_3(), 11)}?=>(
					{
						getUnorderedGroupHelper().select(grammarAccess.getPreambleAccess().getUnorderedGroup_3(), 11);
								...
								({true}?=>(otherlv_44='output'
								{
									newLeafNode(otherlv_44, grammarAccess.getPreambleAccess().getOutputKeyword_3_11_0());
								}
								(
									(
										lv_output_45_0=RULE_STRING
										{
											newLeafNode(lv_output_45_0, grammarAccess.getPreambleAccess().getOutputSTRINGTerminalRuleCall_3_11_1_0());
										}
										{
											if ($current==null) {
												$current = createModelElement(grammarAccess.getPreambleRule());
				...
				{getUnorderedGroupHelper().canSelect(grammarAccess.getPreambleAccess().getUnorderedGroup_3(), 12)}?=>(
					{
						getUnorderedGroupHelper().select(grammarAccess.getPreambleAccess().getUnorderedGroup_3(), 12);
								...
								({true}?=>(otherlv_46='created'
								{
									newLeafNode(otherlv_46, grammarAccess.getPreambleAccess().getCreatedKeyword_3_12_0());
								}
								(
									(
										{
								...
								(
									(
										lv_createcomment_48_0=RULE_STRING
										{
											newLeafNode(lv_createcomment_48_0, grammarAccess.getPreambleAccess().getCreatecommentSTRINGTerminalRuleCall_3_12_2_0());
										}
										{
											if ($current==null) {
												$current = createModelElement(grammarAccess.getPreambleRule());
				...
				{getUnorderedGroupHelper().canSelect(grammarAccess.getPreambleAccess().getUnorderedGroup_3(), 13)}?=>(
					{
						getUnorderedGroupHelper().select(grammarAccess.getPreambleAccess().getUnorderedGroup_3(), 13);
								...
								({true}?=>(otherlv_49='modified'
								{
									newLeafNode(otherlv_49, grammarAccess.getPreambleAccess().getModifiedKeyword_3_13_0());
								}
								(
									(
										{
								...
								(
									(
										lv_modcomment_51_0=RULE_STRING
										{
											newLeafNode(lv_modcomment_51_0, grammarAccess.getPreambleAccess().getModcommentSTRINGTerminalRuleCall_3_13_2_0());
										}
										{
											if ($current==null) {
												$current = createModelElement(grammarAccess.getPreambleRule());
...
@after {
	...
	(
		(
			otherlv_0='set'
			{
				newLeafNode(otherlv_0, grammarAccess.getAssignmentAccess().getSetKeyword_0_0());
			}
			    |
			(
				(
					lv_local_1_0='def'
					{
						newLeafNode(lv_local_1_0, grammarAccess.getAssignmentAccess().getLocalDefKeyword_0_1_0());
					}
					{
						if ($current==null) {
		...
		(
			(
				(
					...
					{
						newLeafNode(lv_recipient_2_0, grammarAccess.getAssignmentAccess().getRecipientLOWERCASE_IDTerminalRuleCall_1_0_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getAssignmentRule());
			...
			otherlv_3='.'
			{
				newLeafNode(otherlv_3, grammarAccess.getAssignmentAccess().getFullStopKeyword_1_1());
			}
		)?
		(
			(
				...
				{
					newLeafNode(lv_variable_4_0, grammarAccess.getAssignmentAccess().getVariableLOWERCASE_IDTerminalRuleCall_2_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getAssignmentRule());
	...
	(
		...
		(
			...
			(
				(
					{
						newCompositeNode(grammarAccess.getValueWithConstructorAccess().getLiteralLiteralParserRuleCall_1_5_0());
					}
			...
			(
				(
					{
						newCompositeNode(grammarAccess.getValueWithConstructorAccess().getIdPathNameParserRuleCall_1_7_0());
					}
			...
			(
				(
					...
					{
						newLeafNode(lv_constant_13_0, grammarAccess.getValueWithConstructorAccess().getConstantUPPERCASE_IDTerminalRuleCall_1_10_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getValueWithConstructorRule());
			...
			(
				(
					...
					{
						newLeafNode(lv_expression_15_0, grammarAccess.getValueWithConstructorAccess().getExpressionEXPRTerminalRuleCall_1_12_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getValueWithConstructorRule());
			...
			(
				(
					(
						lv_component_18_0='new'
						{
							newLeafNode(lv_component_18_0, grammarAccess.getValueWithConstructorAccess().getComponentNewKeyword_1_15_0_0());
						}
						{
							if ($current==null) {
								$current = createModelElement(grammarAccess.getValueWithConstructorRule());
							}
							setWithLastConsumed($current, "component", lv_component_18_0 != null, "new");
						}
					)
				)
				(
				...
				(
					otherlv_20='('
					{
						newLeafNode(otherlv_20, grammarAccess.getValueWithConstructorAccess().getLeftParenthesisKeyword_1_15_2_0());
					}
					(
						(
							{
							...
							lv_parameters_21_0=ruleParameterList
							{
								if ($current==null) {
									$current = createModelElementForParent(grammarAccess.getValueWithConstructorRule());
								}
					...
					otherlv_22=')'
					{
						newLeafNode(otherlv_22, grammarAccess.getValueWithConstructorAccess().getRightParenthesisKeyword_1_15_2_2());
					}
				)?
			)
		)
		(
			otherlv_23='?'
			{
				newLeafNode(otherlv_23, grammarAccess.getValueWithConstructorAccess().getQuestionMarkKeyword_2_0());
			}
			(
				(
					{
					...
					lv_then_24_0=ruleValueWithConstructor
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getValueWithConstructorRule());
						}
			...
			otherlv_25=':'
			{
				newLeafNode(otherlv_25, grammarAccess.getValueWithConstructorAccess().getColonKeyword_2_2());
			}
			(
				(
					{
					...
					lv_else_26_0=ruleValueWithConstructor
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getValueWithConstructorRule());
						}
