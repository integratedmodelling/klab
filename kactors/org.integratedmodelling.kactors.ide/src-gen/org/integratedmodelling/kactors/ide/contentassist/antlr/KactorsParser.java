...
public class KactorsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KactorsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getKeyValuePairAccess().getAlternatives_0_0_1(), "rule__KeyValuePair__Alternatives_0_0_1");
			...
			builder.put(grammarAccess.getKeyValuePairAccess().getGroup_0_0(), "rule__KeyValuePair__Group_0_0__0");
			...
			builder.put(grammarAccess.getDefinitionAccess().getComponentAssignment_1_0(), "rule__Definition__ComponentAssignment_1_0");
			builder.put(grammarAccess.getDefinitionAccess().getActorAssignment_1_1(), "rule__Definition__ActorAssignment_1_1");
			...
			builder.put(grammarAccess.getKeyValuePairAccess().getNameAssignment_0_0_0(), "rule__KeyValuePair__NameAssignment_0_0_0");
			builder.put(grammarAccess.getKeyValuePairAccess().getInteractiveAssignment_0_0_1_0(), "rule__KeyValuePair__InteractiveAssignment_0_0_1_0");
			builder.put(grammarAccess.getKeyValuePairAccess().getValueAssignment_0_1(), "rule__KeyValuePair__ValueAssignment_0_1");
			builder.put(grammarAccess.getKeyValuePairAccess().getKeyAssignment_1(), "rule__KeyValuePair__KeyAssignment_1");
			builder.put(grammarAccess.getKeyValuePairAccess().getTagAssignment_2(), "rule__KeyValuePair__TagAssignment_2");
