...
public class KactorsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KactorsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMatchAccess().getSetAssignment_6_1(), "rule__Match__SetAssignment_6_1");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_6_3(), "rule__Match__BodyAssignment_6_3");
			builder.put(grammarAccess.getMatchAccess().getQuantityAssignment_7_0(), "rule__Match__QuantityAssignment_7_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_7_2(), "rule__Match__BodyAssignment_7_2");
			builder.put(grammarAccess.getMatchAccess().getExprAssignment_8_0(), "rule__Match__ExprAssignment_8_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_8_2(), "rule__Match__BodyAssignment_8_2");
			builder.put(grammarAccess.getMatchAccess().getNodataAssignment_9_0(), "rule__Match__NodataAssignment_9_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_9_2(), "rule__Match__BodyAssignment_9_2");
			builder.put(grammarAccess.getMatchAccess().getStarAssignment_10_0(), "rule__Match__StarAssignment_10_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_10_2(), "rule__Match__BodyAssignment_10_2");
			builder.put(grammarAccess.getMatchAccess().getAnythingAssignment_11_0(), "rule__Match__AnythingAssignment_11_0");
