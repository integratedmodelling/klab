...
public class KactorsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KactorsGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getPreambleAccess().getLabelAlternatives_2_1_0(), "rule__Preamble__LabelAlternatives_2_1_0");
			...
			builder.put(grammarAccess.getPreambleAccess().getGroup_0(), "rule__Preamble__Group_0__0");
			builder.put(grammarAccess.getPreambleAccess().getGroup_1(), "rule__Preamble__Group_1__0");
			builder.put(grammarAccess.getPreambleAccess().getGroup_2(), "rule__Preamble__Group_2__0");
			builder.put(grammarAccess.getPreambleAccess().getGroup_3(), "rule__Preamble__Group_3__0");
			builder.put(grammarAccess.getPreambleAccess().getGroup_4(), "rule__Preamble__Group_4__0");
			builder.put(grammarAccess.getPreambleAccess().getGroup_5(), "rule__Preamble__Group_5__0");
			builder.put(grammarAccess.getPreambleAccess().getGroup_6(), "rule__Preamble__Group_6__0");
			builder.put(grammarAccess.getPreambleAccess().getGroup_7(), "rule__Preamble__Group_7__0");
			builder.put(grammarAccess.getPreambleAccess().getGroup_8(), "rule__Preamble__Group_8__0");
			...
			builder.put(grammarAccess.getPreambleAccess().getNameAssignment_0_1(), "rule__Preamble__NameAssignment_0_1");
			builder.put(grammarAccess.getPreambleAccess().getWorldviewAssignment_1_1(), "rule__Preamble__WorldviewAssignment_1_1");
			builder.put(grammarAccess.getPreambleAccess().getLabelAssignment_2_1(), "rule__Preamble__LabelAssignment_2_1");
			builder.put(grammarAccess.getPreambleAccess().getDescriptionAssignment_3_1(), "rule__Preamble__DescriptionAssignment_3_1");
			builder.put(grammarAccess.getPreambleAccess().getPermissionsAssignment_4_1(), "rule__Preamble__PermissionsAssignment_4_1");
			builder.put(grammarAccess.getPreambleAccess().getAuthorsAssignment_5_1(), "rule__Preamble__AuthorsAssignment_5_1");
			builder.put(grammarAccess.getPreambleAccess().getVersionAssignment_6_1(), "rule__Preamble__VersionAssignment_6_1");
			builder.put(grammarAccess.getPreambleAccess().getCreatedAssignment_7_1(), "rule__Preamble__CreatedAssignment_7_1");
			builder.put(grammarAccess.getPreambleAccess().getModifiedAssignment_8_1(), "rule__Preamble__ModifiedAssignment_8_1");
			builder.put(grammarAccess.getPreambleAccess().getModcommentAssignment_8_2(), "rule__Preamble__ModcommentAssignment_8_2");
			...
			builder.put(grammarAccess.getTableClassifierAccess().getObservableAssignment_7(), "rule__TableClassifier__ObservableAssignment_7");
			...
			builder.put(grammarAccess.getPreambleAccess().getUnorderedGroup(), "rule__Preamble__UnorderedGroup");
		}
	}
