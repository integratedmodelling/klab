...
public class KactorsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KactorsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMatchAccess().getAlternatives_8_1(), "rule__Match__Alternatives_8_1");
			builder.put(grammarAccess.getMatchAccess().getAlternatives_8_4(), "rule__Match__Alternatives_8_4");
			...
			builder.put(grammarAccess.getPreambleAccess().getUserAssignment_1_0_1(), "rule__Preamble__UserAssignment_1_0_1");
			builder.put(grammarAccess.getPreambleAccess().getLibraryAssignment_1_0_2(), "rule__Preamble__LibraryAssignment_1_0_2");
			builder.put(grammarAccess.getPreambleAccess().getBehaviorAssignment_1_0_3(), "rule__Preamble__BehaviorAssignment_1_0_3");
			...
			builder.put(grammarAccess.getStatementAccess().getValueAssignment_7(), "rule__Statement__ValueAssignment_7");
			...
			builder.put(grammarAccess.getNextStatementAccess().getValueAssignment_1_7(), "rule__NextStatement__ValueAssignment_1_7");
			...
			builder.put(grammarAccess.getMatchAccess().getTextAssignment_6_0(), "rule__Match__TextAssignment_6_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_6_2(), "rule__Match__BodyAssignment_6_2");
			builder.put(grammarAccess.getMatchAccess().getArgumentsAssignment_7_0(), "rule__Match__ArgumentsAssignment_7_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_7_2(), "rule__Match__BodyAssignment_7_2");
			builder.put(grammarAccess.getMatchAccess().getInt0Assignment_8_0(), "rule__Match__Int0Assignment_8_0");
			builder.put(grammarAccess.getMatchAccess().getLeftLimitAssignment_8_1_0(), "rule__Match__LeftLimitAssignment_8_1_0");
			builder.put(grammarAccess.getMatchAccess().getInt1Assignment_8_3(), "rule__Match__Int1Assignment_8_3");
			builder.put(grammarAccess.getMatchAccess().getRightLimitAssignment_8_4_0(), "rule__Match__RightLimitAssignment_8_4_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_8_6(), "rule__Match__BodyAssignment_8_6");
			...
			builder.put(grammarAccess.getMatchAccess().getDateAssignment_11_0(), "rule__Match__DateAssignment_11_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_11_2(), "rule__Match__BodyAssignment_11_2");
			builder.put(grammarAccess.getMatchAccess().getExprAssignment_12_0(), "rule__Match__ExprAssignment_12_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_12_2(), "rule__Match__BodyAssignment_12_2");
			builder.put(grammarAccess.getMatchAccess().getNodataAssignment_13_0(), "rule__Match__NodataAssignment_13_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_13_2(), "rule__Match__BodyAssignment_13_2");
			builder.put(grammarAccess.getMatchAccess().getStarAssignment_14_0(), "rule__Match__StarAssignment_14_0");
			builder.put(grammarAccess.getMatchAccess().getBodyAssignment_14_2(), "rule__Match__BodyAssignment_14_2");
			builder.put(grammarAccess.getMatchAccess().getAnythingAssignment_15_0(), "rule__Match__AnythingAssignment_15_0");
