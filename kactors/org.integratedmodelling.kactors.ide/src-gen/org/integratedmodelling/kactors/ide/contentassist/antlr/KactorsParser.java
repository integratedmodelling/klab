...
public class KactorsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KactorsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPreambleAccess().getAlternatives_1_0_0(), "rule__Preamble__Alternatives_1_0_0");
			builder.put(grammarAccess.getPreambleAccess().getAlternatives_1_0_0_0_0(), "rule__Preamble__Alternatives_1_0_0_0_0");
			...
			builder.put(grammarAccess.getPreambleAccess().getGroup_1_0_0_0(), "rule__Preamble__Group_1_0_0_0__0");
			...
			builder.put(grammarAccess.getPreambleAccess().getComponentAssignment_1_0_2(), "rule__Preamble__ComponentAssignment_1_0_2");
			builder.put(grammarAccess.getPreambleAccess().getUserAssignment_1_0_3(), "rule__Preamble__UserAssignment_1_0_3");
			builder.put(grammarAccess.getPreambleAccess().getLibraryAssignment_1_0_4(), "rule__Preamble__LibraryAssignment_1_0_4");
			builder.put(grammarAccess.getPreambleAccess().getBehaviorAssignment_1_0_5(), "rule__Preamble__BehaviorAssignment_1_0_5");
			...
			builder.put(grammarAccess.getValueWithMetadataAccess().getIdAssignment_0_4(), "rule__ValueWithMetadata__IdAssignment_0_4");
			builder.put(grammarAccess.getValueWithMetadataAccess().getListAssignment_0_5(), "rule__ValueWithMetadata__ListAssignment_0_5");
			builder.put(grammarAccess.getValueWithMetadataAccess().getMapAssignment_0_6(), "rule__ValueWithMetadata__MapAssignment_0_6");
			builder.put(grammarAccess.getValueWithMetadataAccess().getObservableAssignment_0_7(), "rule__ValueWithMetadata__ObservableAssignment_0_7");
			builder.put(grammarAccess.getValueWithMetadataAccess().getExpressionAssignment_0_8(), "rule__ValueWithMetadata__ExpressionAssignment_0_8");
			builder.put(grammarAccess.getValueWithMetadataAccess().getTableAssignment_0_9(), "rule__ValueWithMetadata__TableAssignment_0_9");
			builder.put(grammarAccess.getValueWithMetadataAccess().getQuantityAssignment_0_10(), "rule__ValueWithMetadata__QuantityAssignment_0_10");
			...
			builder.put(grammarAccess.getKeyValuePairAccess().getKeyAssignment_0_0(), "rule__KeyValuePair__KeyAssignment_0_0");
			builder.put(grammarAccess.getKeyValuePairAccess().getValueAssignment_0_1(), "rule__KeyValuePair__ValueAssignment_0_1");
