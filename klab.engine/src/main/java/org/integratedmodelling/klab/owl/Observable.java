        ...
        if (this.getType().is(Type.EXTENSIVE_PROPERTY)) {
            ...
            if (unit != null) {
                ...
                if (scale.isSpatiallyDistributed()
                        && !Units.INSTANCE.isSpatialDensity(unit, scale.getSpace())) {
    ...
    public boolean canResolve(Observable obj) {
        if (this.main.equals(obj.main)) {
            ...
            if (this.classifier != null && obj.classifier != null && obj.classifier.equals(this.classifier)) {
                return ((this.downTo == null && obj.downTo == null) || ((this.downTo != null
                        && obj.downTo != null
    ...
    public IModel getReferencedModel() {
        if (this.resolvedModel == null && this.modelReference != null) {
            ...
            if (!(model instanceof IModel)) {
                throw new KlabValidationException("referenced object " + modelReference
                        + " does not exist or is not a model");
            }
