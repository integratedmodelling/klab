...
public class ObservableBuilder implements IObservable.Builder {
    ...
    public Concept makeDistance(IConcept concept, boolean addDefinition) {
        ...
        if (conceptId == null) {
             ...
             */
            OWL.INSTANCE
                    .restrictSome(ret, Concepts.p(NS.IS_INHERENT_TO_PROPERTY), (IConcept) concept, ontology);
        }
    ...
    public Concept buildConcept() throws KlabValidationException {
        ...
        if (inherent != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(inherent, other)) {
                monitor.error("cannot set the inherent type of " + Concepts.INSTANCE.getDisplayName(main)
                        + " to "
        ...
        if (context != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(context, other)) {
                monitor.error("cannot set the context type of " + Concepts.INSTANCE.getDisplayName(main)
                        + " to "
        ...
        if (compresent != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(compresent, other)) {
                monitor.error("cannot set the compresent type of " + Concepts.INSTANCE.getDisplayName(main)
                        + " to "
                        + Concepts.INSTANCE.getDisplayName(context)
        ...
        if (caused != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(caused, other)) {
                monitor.error("cannot set the caused type of " + Concepts.INSTANCE.getDisplayName(main)
                        + " to "
        ...
        if (causant != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(causant, other)) {
                monitor.error("cannot set the causant type of " + Concepts.INSTANCE.getDisplayName(main)
                        + " to "
        ...
        if (adjacent != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(adjacent, other)) {
                monitor.error("cannot set the adjacent type of " + Concepts.INSTANCE.getDisplayName(main)
                        + " to "
        ...
        if (relationshipSource != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(relationshipSource, other)) {
                monitor.error("cannot set the relationship source type of " + Concepts.INSTANCE.getDisplayName(main)
                        + " to "
            ...
            if (other2 != null && !Observables.INSTANCE.isCompatible(relationshipTarget, other2)) {
                monitor.error("cannot set the relationship target type of " + Concepts.INSTANCE.getDisplayName(main)
                        + " to "
                        + Concepts.INSTANCE.getDisplayName(relationshipTarget)
                        + " as it already has an incompatible target type: "
                        + Concepts.INSTANCE.getDisplayName(other2), declaration);
            }
        ...
        axioms.add(Axiom
                .AnnotationAssertion(conceptId, NS.CONCEPT_DEFINITION_PROPERTY, declaration.getDefinition()));
    ...
    private Ontology getTargetOntology() {
        return Ontologies.INSTANCE
                .getTargetOntology(ontology, main, traits, roles, inherent, context, caused, causant, compresent, goal, cooccurrent, adjacent);
    }
