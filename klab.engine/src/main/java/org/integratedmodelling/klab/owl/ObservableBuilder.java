...
public class ObservableBuilder implements IObservable.Builder {
    ...
    public Builder without(IConcept... concepts) {
        ...
        for (IConcept concept : concepts) {
            Pair<Collection<IConcept>, Collection<IConcept>> tdelta = Concepts.INSTANCE
                    .copyWithout(this.traits, concept);
            ...
            Pair<Collection<IConcept>, Collection<IConcept>> rdelta = Concepts.INSTANCE
                    .copyWithout(this.roles, concept);
    ...
    public Builder withoutAny(IConcept... concepts) {
        ...
        for (IConcept concept : concepts) {
            Pair<Collection<IConcept>, Collection<IConcept>> tdelta = Concepts.INSTANCE
                    .copyWithoutAny(this.traits, concept);
            ret.traits.addAll(tdelta.getFirst());
            ret.removed.addAll(tdelta.getSecond());
            Pair<Collection<IConcept>, Collection<IConcept>> rdelta = Concepts.INSTANCE
                    .copyWithoutAny(this.roles, concept);
            ret.roles.addAll(rdelta.getFirst());
            ret.removed.addAll(rdelta.getSecond());
    ...
    public static Concept makeProportion(IConcept concept, @Nullable IConcept comparison, boolean addDefinition, boolean isPercentage) {
    ...
    public Concept build() throws KlabValidationException {
        ...
        if (adjacent != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(adjacent, other)) {
                throw new KlabValidationException("cannot add adjacent "
        ...
        if (cooccurrent != null) {
            ...
            if (other != null && !Observables.INSTANCE.isCompatible(cooccurrent, other)) {
                throw new KlabValidationException("cannot add co-occurrent "
                        + Concepts.INSTANCE.getDisplayName(cooccurrent) + " to concept "
                        + Concepts.INSTANCE.getDisplayName(main)
