...
public class Concept extends Knowledge implements IConcept {
    ...
    public int resolves(IConcept concept) {
        ...
        int component = getDistance(Observables.INSTANCE.getContextType(this), Observables.INSTANCE
                .getContextType(concept), true);
        ...
        component = getDistance(Observables.INSTANCE.getInherentType(this), Observables.INSTANCE
                .getInherentType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getGoalType(this), Observables.INSTANCE
                .getGoalType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getCooccurrentType(this), Observables.INSTANCE
                .getCooccurrentType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getCausantType(this), Observables.INSTANCE
                .getCausantType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getCausedType(this), Observables.INSTANCE
                .getCausedType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getAdjacentType(this), Observables.INSTANCE
                .getAdjacentType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getCompresentType(this), Observables.INSTANCE
                .getCompresentType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getComparisonType(this), Observables.INSTANCE
                .getComparisonType(concept), false);
