    ...
    static public class OptimizedRoute{
        ...
        public static class Trip{
            ...
            public Trip(
                    ...
                    @JsonProperty("legs") List<Navigation> legs,
                    @JsonProperty("summary") TripSummary summary,
            ...
            public static class TripSummary{
                ...
                @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
                public TripSummary(
                        @JsonProperty("hast_time_restrictions") boolean hasTimeRestrictions,
                        @JsonProperty("has_toll") boolean hasToll,
                        @JsonProperty("has_highway") boolean hasHighway,
                        @JsonProperty("has_ferry") boolean hasFerry,
                        @JsonProperty("min_lat") Double minLat,
                        @JsonProperty("min_lon") Double minLon,
                        @JsonProperty("max_lat") Double maxLat,
                        @JsonProperty("max_lon") Double maxLon,
                        @JsonProperty("time") Double time,
                ...
                public Map<String,Object> exportAsMap(){
                    return Map.ofEntries(
                            Map.entry("has_time_restrictions", hasTimeRestrictions),
                            Map.entry("has_toll", hasToll),
                            Map.entry("has_highway", hasHighway),
                            Map.entry("has_ferry", hasFerry),
                            Map.entry("min_lat", minLat),
                            Map.entry("min_lon", minLon),
                            Map.entry("max_lat", maxLat),
                            Map.entry("max_lon", maxLon),
                            Map.entry("time", time),
            ...
            public static class Navigation{
                ...
                @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
                public Navigation(
                        @JsonProperty("maneuvers") List<Object> maneuvers,
                        @JsonProperty("summary") TripSummary summary,
                        @JsonProperty("shape") String path){
            ...
            public static class Location{
                ...
                public Map<String,Object> exportAsMap(){
                    return Map.of("type", type, "lon", lon, "lat", lat, "side_of_street", sideOfStreet, "original_index", originalIndex);
                }
            }
