...
public class LiteralCharacterizingResolver extends AbstractContextualizer
        implements
            IResolver<IArtifact>,
            IProcessor,
            IExpression {
    ...
    public Object eval(IContextualizationScope context, Object... parameters) throws KlabException {
        return new LiteralCharacterizingResolver(Concepts.INSTANCE.asConcept(Parameters.create(parameters).get("val")));
    }
    ...
    public IArtifact resolve(IArtifact ret, IContextualizationScope context) throws KlabException {
        ...
        List<IConcept> traits = this.value.is(IKimConcept.Type.INTERSECTION)
