...
public class ObjectClassificationResolver implements IResolver<IState>, IProcessor, IExpression {
	...
	public ObjectClassificationResolver(IValueMediator from, IValueMediator to) {
		this.from = from;
		this.to = to;
	}
	...
	public Object eval(IParameters<String> parameters, IComputationContext context) throws KlabException {
		return new ObjectClassificationResolver((IValueMediator) parameters.get("original"),
