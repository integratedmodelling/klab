...
public class Shape extends AbstractExtent implements IShape {
    ...
    // the shape in an appropriate meter projection. If metersComputed is true and
    // metered == null,
    // this is in
    // meters already.
    ...
    public static Shape create(Envelope envelope) {
        return create(envelope.getMinX(), envelope.getMinY(), envelope.getMaxX(), envelope.getMaxY(), (Projection) envelope
                .getProjection());
    }
