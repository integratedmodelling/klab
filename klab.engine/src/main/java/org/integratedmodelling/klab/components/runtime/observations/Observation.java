...
public abstract class Observation extends ObservedArtifact implements IObservation, IActorIdentity<KlabMessage> {
    ...
    /**
     * Get any modification that still needs to be reported and reset our list to empty.
     * 
     * @return
     */
    ...
    public Reference getActor() {
        ...
        if (this.actor == null) {
            ...
            /*
             * wait for instrumentation to succeed. Couldn't figure out the ask pattern. TODO when
             * this has a chance to fail (e.g. in a cluster situation), add a timeout, or figure out
             * the ask pattern.
             */
