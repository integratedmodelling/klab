...
public class DistanceResolver implements IResolver<IDataArtifact>, IExpression {
	...
	public IDataArtifact resolve(IDataArtifact ret, IContextualizationScope context) throws KlabException {
		...
		// TODO this will need to be switchable to a cost surface analysis when available.
		...
		context.getMonitor().info("computing distances over a " + context.getScale().size() + "-pixel grid...");
