...
//				ret.add(alternative);
            ...
            /*
             * target is a predicate and has no inherency: we add the inherent type of the context as it's illegal to 
             * write a naked "model predicate" characterizer to resolve the predicate independent of context.
             */
