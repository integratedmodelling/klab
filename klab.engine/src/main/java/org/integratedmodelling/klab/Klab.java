...
public enum Klab implements IRuntimeService {
    ...
    public IStorageProvider getStorageProvider() {
        ...
        if (storageProvider == null) {
            ...
            if (nproviders > 1 && providerComponent == null) {
                throw new KlabConfigurationException("multiple storage providers found: please configure the class of the desired provider");
            }
        }
    ...
    public IRuntimeProvider getRuntimeProvider() {
        ...
        if (runtimeProvider == null) {
            ...
            if (nproviders > 1 && providerComponent == null) {
                throw new KlabConfigurationException("multiple dataflow runtime components found: please configure the class of the desired provider");
            }
        }
     ...
     * 
     * @param user
     *            the identity requesting the capabilities.
     * 
    ...
    public Capabilities getCapabilities(IIdentity user) {
        ...
        ret.setOnline(Authentication.INSTANCE
                .getAuthenticatedIdentity(INetworkSessionIdentity.class) != null);
        // TODO
