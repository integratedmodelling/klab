...
public class LicenseManager {
    ...
    static {
        /*
         * obsolete URLs to be officially translated
         */
        translateUrls.put("http://150.241.131.4/tl0", "https://integratedmodelling.org/collaboration");
        translateUrls.put("http://integratedmodelling.org/tl0/", "https://integratedmodelling.org/collaboration");
    }
    ...
    public static Properties readCertificate(File certFile, File publicKey, String... keys) {
        ...
        /*
         * support for test certificates: if test.port is there, switch
         * primary server to local server on specified port.
         */
     ...
     */
    public static Properties readCertificate(final File certificate, final URL publicKey, final String... keys) {
        try {
