...
//					int block = Math.min(MAX_PIXELS_IN_MEMORY / cores / width,
...
//		switch (imageType) {
//		case TYPE_INT_RGB:
//			colorModel = new ComponentColorModel(ColorSpace.getInstance(ColorSpace.CS_sRGB), new int[] { 8, 8, 8, 0 },
//					false, false, ComponentColorModel.TRANSLUCENT, DataBuffer.TYPE_BYTE);
//			sampleModel = new BandedSampleModel(DataBuffer.TYPE_BYTE, width, height, 3);
//			break;
//		case TYPE_INT_ARGB:
//			colorModel = new ComponentColorModel(ColorSpace.getInstance(ColorSpace.CS_sRGB), new int[] { 8, 8, 8, 8 },
...
//	}
//
//	private BigBufferedImage(ColorModel cm, SimpleRaster raster, boolean isRasterPremultiplied,
