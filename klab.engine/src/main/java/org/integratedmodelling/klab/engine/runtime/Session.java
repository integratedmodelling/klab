...
public class Session implements ISession, UserDetails, IMessageBus.Relay {
    ...
    private void handleObservationRequest(final ObservationRequest request) {
        ...
        /*
         * TODO if we have no context in the request but the URN is not an observer and we have a ROI, create the
         * context from the ROI and block the thread until it's observed. This should probably go in observe().
         */
