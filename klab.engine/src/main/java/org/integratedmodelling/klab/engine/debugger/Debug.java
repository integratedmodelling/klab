...
public enum Debug {
    ...
    /**
     * Start a timer. The description is saved and printed (sysout for now). When endTimer is called
     * with the handle returned from this, the callback (if not null) will be called passing the
     * period expired.
     * 
     * @param description
     * @param callback
    ...
    public void addDebugger(String id, Debugger debugger) {
