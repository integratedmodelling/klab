...
//	Map<IConcept, Collection<IConcept>> getConcreteIdentities();
    ...
    /**
     * Get the concretized identities for the passed predicates. This should be lenient to a difference
     * in inherency between the passed predicate and the resolved ones.
     * 
     * @param predicate
     * @return
     */
