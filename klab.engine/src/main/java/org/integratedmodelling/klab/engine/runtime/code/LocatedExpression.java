 ...
 * evaluated in a context at a given locator. The expression is aware of all the
 * details of the context and sets up proxies and variables according to what is
...
public class LocatedExpression {
	...
	public <T> T eval(IRuntimeScope scope, ILocator locator, IParameters<String> additionalParameters,
			Class<? extends T> cls) {
