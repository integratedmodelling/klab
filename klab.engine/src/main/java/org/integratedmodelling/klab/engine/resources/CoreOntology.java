...
/**
 * The core workspace only contains OWL ontologies and is read from the
 * classpath.
 * 
...
public class CoreOntology extends AbstractWorkspace {
	...
	public static interface NS {
		...
		/**
		 * Annotation contains the ID of the property (in same ontology) that will be
		 * used to create restrictions to adopt the trait carrying the annotation.
		 */
