...
public class Scale implements IScale {
    ...
    public interface Mediator {
        ...
        // /**
        // * Apply the locators to the original state, adding whatever other locators
        // the mediation
        ...
        // index in the
        // * mediated scale. Weights should be assigned according to coverage and
