...
public class Scale implements IScale {
	...
	public IScale at(Object... locators) {
		...
		// if (getTime() == null) {
		// // I want you just the way you are. If generic, it should already be
		// compatible
		// // by design.
		// targetScale = this;
		// } else {
		// // FIXME/CHECK probably will need an initialization that still holds the
		// period
		// // and step.
	 ...
	 * 
	 * TODO FIXME for now time is small and space doesn't change, so we just copy time
	 * removing any extension events and leave space as is.
	 * 
	 * @param scale
	 * @return
	 */
