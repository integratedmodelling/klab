...
//
//    private static ObservationKbox _this;
...
////    }
//
//    public String storeObservation(IObserver o, long primaryKey, long foreignKey) {
//        return storeObservation(o, primaryKey, foreignKey, -1l, -1l);
//    }
//
//    public String storeObservation(IObserver o, long primaryKey, long foreignKey, long sourceId, long targetId) {
//
//        long typeId = -1;
...
//    }
//
//    class ObservationSerializer implements Serializer<IObserver> {
//
//        @Override
//        public String serialize(IObserver o, long primaryKey, long foreignKey) {
...
////    }
//
//    public static String getObservationCode(IObserver obs) {
...
//    }
//
//    private ObservationKbox(String name, IMonitor monitor) {
//
//        super(name, monitor);
//
...
//     */
//    public List<IObserver> query(IConcept observable, IResolutionScope context)
//            throws KlabException {
//        //
...
//        // context).getMonitor());
//        Set<IObserver> local = new HashSet<>();
//
