...
public class SpatialRescalingTransformation implements IResolver<IState>, IExpression, IProcessor {

	IState state;

	public SpatialRescalingTransformation() {
	}

	public SpatialRescalingTransformation(IParameters<String> parameters, IContextualizationScope context) {
	...
	public Object eval(IParameters<String> parameters, IContextualizationScope context) throws KlabException {
		return new SpatialRescalingTransformation(parameters, context);
	}
