...
public class TemporalRescalingTransformation implements IResolver<IState>, IExpression, IProcessor {

	IState state;

	public TemporalRescalingTransformation() {
	}

	public TemporalRescalingTransformation(IParameters<String> parameters, IContextualizationScope context) {
	...
	public Object eval(IParameters<String> parameters, IContextualizationScope context) throws KlabException {
		return new TemporalRescalingTransformation(parameters, context);
	}
