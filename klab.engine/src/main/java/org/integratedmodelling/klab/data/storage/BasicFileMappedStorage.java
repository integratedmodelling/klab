...
/**
 * Just a chunk of memory that uses a backing memory-mapped file and is
 * addressed in an arbitrary number of dimensions, as long as the parameters to
 * get() and set() match the dimensions.
 * 
 * @author Ferd
 *
 * @param <T>
