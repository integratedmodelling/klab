    ...
    public Object getValue(IContextualizationScope scope, IParameters<String> parameters) {
        ...
        if (this.expression != null) {
            if (this.compiled == null) {
                ...
                ILanguageProcessor.Descriptor descriptor = processor
                        .describe(this.expression.getCode(),
                                scope.getExpressionContext(null)
                                        .scalar(this.expression.isForcedScalar() ? Forcing.Always : Forcing.AsNeeded),
