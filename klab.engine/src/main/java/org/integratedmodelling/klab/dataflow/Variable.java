...
public class Variable implements IVariable {
	...
	public static Variable create(IContextualizable contextualizable, Collection<String> knownVariables,
			Actuator actuator) {
	...
	@Override
	public Object getValue(IParameters<String> parameters, IContextualizationScope scope) {
		...
		if (this.expression != null) {
			if (this.compiled == null) {
				...
				ILanguageProcessor processor = Extensions.INSTANCE.getLanguageProcessor(
						this.expression.getLanguage() == null ? Extensions.DEFAULT_EXPRESSION_LANGUAGE
				...
				if (!contextual) {
					...
					this.literal = this.compiled.eval(parameters, scope);
					return this.literal;
				}
			}

			return this.compiled.eval(parameters, scope);
		}
		return null;
	}
