...
public class Model extends KimObject implements IModel {
    ...
    /**
     * Used to resolve a derived strategy for the main observable through observation of the candidate
     * observables and execution of the associated computational strategy.
     * 
