...
public enum Extensions implements IExtensionService {
  ...
  public Object callFunction(IServiceCall functionCall, IComputationContext context)
  ...
  public IExpression compileExpression(String expressionCode, IComputationContext context,
      String language) throws KlabValidationException {
  ...
  public ILanguageProcessor getLanguageProcessor(String language) {
    // TODO
    return (language == null || language.equals(DEFAULT_EXPRESSION_LANGUAGE))
        ? GroovyProcessor.INSTANCE
        : null;
  }
