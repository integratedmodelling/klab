...
public class KimHighlightingConfiguration extends DefaultHighlightingConfiguration {
  ...
  public void configure(IHighlightingConfigurationAcceptor acceptor) {
    ...
    acceptor.acceptDefaultHighlighting(KNOWN_ANNOTATION_ID, "Known Annotation",
        knownAnnotationTextStyle());
    acceptor.acceptDefaultHighlighting(UNKNOWN_ANNOTATION_ID, "Unknown Annotation",
        unknownAnnotationTextStyle());
