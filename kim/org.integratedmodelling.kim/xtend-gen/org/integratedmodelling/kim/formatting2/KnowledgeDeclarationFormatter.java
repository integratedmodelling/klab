...
public class KnowledgeDeclarationFormatter extends AbstractFormatter2 {
  @Inject
  @Extension
  private KnowledgeDeclarationGrammarAccess _knowledgeDeclarationGrammarAccess;
  ...
  protected void _format(final ObservableSemantics observableSemantics, @Extension final IFormattableDocument document) {
    ...
    document.<org.integratedmodelling.kim.kdecl.Number>format(observableSemantics.getFrom());
    document.<org.integratedmodelling.kim.kdecl.Number>format(observableSemantics.getTo());
  }
