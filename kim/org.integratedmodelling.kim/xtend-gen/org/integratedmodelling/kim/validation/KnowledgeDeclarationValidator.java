...
import org.integratedmodelling.kim.validation.AbstractKnowledgeDeclarationValidator;
...
public class KnowledgeDeclarationValidator extends AbstractKnowledgeDeclarationValidator {
  @Check
  ...
  public void checkObservableSemantics(final ObservableSemantics semantics) {
    ...
    if ((declaration != null)) {
      ...
      org.integratedmodelling.kim.kdecl.Number _from = semantics.getFrom();
      ...
      if (_tripleNotEquals_3) {
        if ((((declaration.is(IKimConcept.Type.PROPORTION) || declaration.is(IKimConcept.Type.PROBABILITY)) || declaration.is(IKimConcept.Type.ANGLE)) || 
          ...
          this.error("Numeric range can not be specified for proportions, percentages, probabilities and angles", 
            semantics.getFrom(), null, KdeclPackage.OBSERVABLE_SEMANTICS__FROM);
        } else {
  ...
  public EnumSet<IKimConcept.Type> checkDeclaration(final ConceptDeclaration declaration) {
        ...
        if (_isEmpty) {
          ...
          if ((flags.contains(IKimConcept.Type.OBSERVABLE) || flags.contains(IKimConcept.Type.CONFIGURATION))) {
            if ((type.contains(IKimConcept.Type.OBSERVABLE) || type.contains(IKimConcept.Type.CONFIGURATION))) {
              this.error(
                "Concept declarations can only contain one observable (quality, process, subject, event or relationship) or configuration", main, null, KdeclPackage.CONCEPT_DECLARATION__MAIN);
              error = true;
            } else {
              type = flags;
            }
          ...
          if (_not) {
            if ((macro != null)) {
              ...
              this.error(_plus_2, main, null, KdeclPackage.CONCEPT_DECLARATION__MAIN);
              error = true;
            } else {
              macro = mmacro;
                    ...
                    switch (field) {
                      ...
                      case CAUSED:
                        if (((!mtype.isOptional()) && (declaration.getCaused() == null))) {
                          ...
                          this.error(_plus_10, main, null, KdeclPackage.CONCEPT_DECLARATION__MAIN);
                          error = true;
                        }
                        break;
                      case COMPRESENT:
                        if (((!mtype.isOptional()) && (declaration.getCompresent() == null))) {
                          ...
                          this.error(_plus_13, main, null, KdeclPackage.CONCEPT_DECLARATION__MAIN);
                          error = true;
                        }
                        break;
                      case CONTEXT:
                        if (((!mtype.isOptional()) && (declaration.getContext() == null))) {
                          ...
                          this.error(_plus_16, main, null, KdeclPackage.CONCEPT_DECLARATION__MAIN);
                          error = true;
                        }
                        break;
                      case GOAL:
                        if (((!mtype.isOptional()) && (declaration.getMotivation() == null))) {
                          ...
                          this.error(_plus_19, main, null, KdeclPackage.CONCEPT_DECLARATION__MAIN);
                          error = true;
                        }
                        break;
                      case INHERENT:
        ...
        if (_not_1) {
          if (((macro != null) && macro.getFields().contains(IKimMacro.Field.INHERENT))) {
            ...
            if (_not_2) {
              ...
              String _plus_1 = (_plus + " macro");
              this.error(_plus_1, 
                declaration.getInherency(), null, KdeclPackage.CONCEPT_DECLARATION__INHERENCY);
              error = true;
            } else {
    ...
    if (_tripleNotEquals_1) {
      boolean _contains_2 = type.contains(IKimConcept.Type.OBSERVABLE);
      boolean _not_3 = (!_contains_2);
      if (_not_3) {
        this.error("Only observables can have context", declaration.getContext(), null, 
          KdeclPackage.CONCEPT_DECLARATION__INHERENCY);
      }
      ...
      if (_isEmpty_2) {
        ...
        boolean _contains_3 = flags.contains(IKimConcept.Type.MACRO);
      ...
      if (_isEmpty_3) {
        ...
        if (_not_7) {
          if (((macro != null) && macro.getFields().contains(IKimMacro.Field.COMPRESENT))) {
            ...
            boolean _not_8 = (!_containsAll_2);
            if (_not_8) {
              String _name_2 = macro.getName();
              String _plus_4 = ("The compresent type (with) does not match the type requested by the " + _name_2);
              String _plus_5 = (_plus_4 + 
                " macro");
              this.error(_plus_5, declaration.getCompresent(), null, KdeclPackage.CONCEPT_DECLARATION__COMPRESENT);
              error = true;
            } else {
      ...
      if (_isEmpty_4) {
        ...
        if (_not_9) {
          if (((macro != null) && macro.getFields().contains(IKimMacro.Field.CAUSANT))) {
            ...
            boolean _not_10 = (!_containsAll_3);
            if (_not_10) {
              String _name_3 = macro.getName();
              String _plus_6 = ("The causant type (from) does not match the type requested by the " + _name_3);
              String _plus_7 = (_plus_6 + 
                " macro");
              this.error(_plus_7, declaration.getCausant(), null, KdeclPackage.CONCEPT_DECLARATION__CAUSANT);
              error = true;
            } else {
      ...
      if (_isEmpty_5) {
        ...
        if (_not_11) {
          if (((macro != null) && macro.getFields().contains(IKimMacro.Field.CAUSED))) {
            ...
            boolean _not_12 = (!_containsAll_4);
            if (_not_12) {
              ...
              this.error(_plus_9, 
                declaration.getCaused(), null, KdeclPackage.CONCEPT_DECLARATION__CAUSED);
              error = true;
            } else {
        ...
        if (_not_13) {
          if (((macro != null) && macro.getFields().contains(IKimMacro.Field.GOAL))) {
            ...
            if (_not_14) {
              ...
              this.error(_plus_11, 
                declaration.getMotivation(), null, KdeclPackage.CONCEPT_DECLARATION__MOTIVATION);
              error = true;
            } else {
      ...
      for (final ConceptDeclaration operand : _operands) {
        {
          ...
          if (_not_16) {
            ...
            this.error(_plus_13, operand, KdeclPackage.Literals.CONCEPT_DECLARATION__OPERANDS, i);
            error = true;
          }
          i++;
        }
          ...
          if (_not_1) {
            ...
            if (_isCount) {
              ...
              if (_not_2) {
                ...
                this.error(_plus_4, 
                  concept.getConcept(), null, KdeclPackage.CONCEPT__CONCEPT);
              }
  ...
  public void checkConceptDefinition(final ConceptStatement statement) {
    ...
    if (_isDeniable) {
      if (((!type.contains(IKimConcept.Type.ATTRIBUTE)) || type.contains(IKimConcept.Type.ORDERING))) {
        this.error("Only attributes can be deniable", KdeclPackage.Literals.CONCEPT_STATEMENT__DENIABLE);
        ok = false;
      } else {
    ...
    if (_isSubjective) {
      ...
      boolean _not = (!_contains);
      if (_not) {
        this.error("Only attributes can be subjective", KdeclPackage.Literals.CONCEPT_STATEMENT__SUBJECTIVE);
        ok = false;
      } else {
        type.add(IKimConcept.Type.SUBJECTIVE);
      }
        ...
        for (final Annotation annotation : _annotations) {
          {
            ...
            for (final KimNotification notification : _validateUsage) {
              this.notify(notification, statement, KdeclPackage.Literals.CONCEPT_STATEMENT__ANNOTATIONS, i_1);
            }
            i_1++;
          }
        }
  ...
  public KimConceptStatement validateConceptBody(final ConceptStatementBody concept, final KimNamespace namespace, final KimConceptStatement parent, final EnumSet<IKimConcept.Type> type) {
    ...
    if (_tripleNotEquals) {
      this.error("A concept can only be declared once", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__NAME);
    }
    ...
    if (_greaterThan) {
      ...
      if (_isCoreConcept) {
        ...
        if ((parent != null)) {
          this.error("Cannot attribute parents to a non-top level child concept. Use \"inherits\" to add traits.", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__PARENTS);
          ok = false;
        }
        int i = 0;
                    ...
                    if (((declaration != null) && (!declaration.getType().isEmpty()))) {
                      if (((i == 0) || Objects.equal(concept.getConnectors().get((i - 1)), ","))) {
                        ...
                        if ((Objects.equal(connector, BinarySemanticOperator.FOLLOWS) && 
                          ...
                          this.error("The consequentiality (\'follows\') operator is only allowed between events", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__PARENTS, i);
                          error = true;
                        }
                        if (((group_1.getConnector() != BinarySemanticOperator.NONE) && (!Objects.equal(group_1.getConnector(), connector)))) {
                          this.error(
                            "Cannot mix union (\'or\'), intersection (\'and\') and consequentiality (\'follows\') operators", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__PARENTS, i);
                          error = true;
                        } else {
      ...
      for (final ConceptDeclaration trait : _actuallyInheritedTraits) {
        {
          ...
          if (_not_1) {
            this.error("Only traits can be inherited", concept, 
              KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__ACTUALLY_INHERITED_TRAITS, i_1);
            ok = false;
          } else {
    ...
    int _size_3 = concept.getContextualizedTraits().size();
    boolean _greaterThan_3 = (_size_3 > 0);
    if (_greaterThan_3) {
      boolean _contains = type.contains(IKimConcept.Type.CLASS);
      boolean _not_1 = (!_contains);
      if (_not_1) {
        this.error("Only a class can expose traits", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__CHILDREN);
        ok = false;
      } else {
        int i_2 = 0;
        EList<ObservableSemantics> _contextualizedTraits = concept.getContextualizedTraits();
        for (final ObservableSemantics trait_1 : _contextualizedTraits) {
          {
            EnumSet<IKimConcept.Type> ttype = this.checkDeclaration(trait_1.getDeclaration());
            boolean _contains_1 = ttype.contains(IKimConcept.Type.TRAIT);
            boolean _not_2 = (!_contains_1);
            if (_not_2) {
              this.error("Only traits can be exposed by classes", concept, 
                KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__ACTUALLY_INHERITED_TRAITS, i_2);
              ok = false;
            } else {
              ret.getTraitsExposed().add(Kim.INSTANCE.declareObservable(trait_1));
            }
            i_2++;
          }
        }
        boolean _isSpecific = concept.isSpecific();
        boolean _not_2 = (!_isSpecific);
        ret.setDefiningExposedTraits(_not_2);
      }
    }
    ...
    if (_tripleNotEquals_4) {
      if (((((!type.contains(IKimConcept.Type.ATTRIBUTE)) && (!type.contains(IKimConcept.Type.REALM))) && (!type.contains(IKimConcept.Type.ORDERING))) && 
        ...
        this.error("The \'describes\' clause can only be stated by attributes, orderings, realms and qualities", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__DESCRIBED_QUALITY);
        ok = false;
      }
    ...
    if (_tripleNotEquals_7) {
      if (((!type.contains(IKimConcept.Type.ATTRIBUTE)) && (!type.contains(IKimConcept.Type.REALM)))) {
        this.error(
          "The \'classifies\' clause can only be stated by attributes or realms. Use \'discretizes\' for orderings.", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__CLASSIFIES_QUALITY);
        ok = false;
      }
      EnumSet<IKimConcept.Type> ttype_3 = this.checkDeclaration(concept.getClassifiesQuality());
      boolean _contains_2 = ttype_3.contains(IKimConcept.Type.QUALITY);
      boolean _not_3 = (!_contains_2);
      if (_not_3) {
    ...
    if (_tripleNotEquals_8) {
      ...
      boolean _not_4 = (!_contains_3);
      if (_not_4) {
        this.error("The \'discretizes\' clause can only be stated by attributes. Use \'classifies\' for attributes.", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__DISCRETIZES_QUALITY);
        ok = false;
      }
    ...
    if (_tripleNotEquals_9) {
      boolean _contains_4 = type.contains(IKimConcept.Type.DENIABLE);
      boolean _not_5 = (!_contains_4);
      if (_not_5) {
        this.error(
          "The \'marks\' clause can only be stated by deniable attributes to indicate non-zero values of a quality.", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__DESCRIBED_NONZERO_QUALITY);
        ok = false;
      }
    ...
    if (_greaterThan_4) {
      boolean _contains_5 = type.contains(IKimConcept.Type.OBSERVABLE);
      boolean _not_6 = (!_contains_5);
      if (_not_6) {
        this.error("only observables can have roles.", concept, 
        ...
        for (final ConceptDeclaration t : _targetObservables) {
          {
            ...
            if (_not_7) {
              this.error("Role targets must be countable concepts (subject, event or relationship)", concept, 
                KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__TARGET_OBSERVABLES, i_3);
              ok = false;
            } else {
              targets.add(target);
            }
        ...
        for (final ConceptDeclaration t_1 : _restrictedObservables) {
          {
            ...
            if (_not_7) {
              this.error(
                "Role target scenarios can only be countable concepts (subject, event or relationship)", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__RESTRICTED_OBSERVABLES, i_3);
              ok = false;
            } else {
        ...
        for (final ConceptDeclaration r : _roles) {
          {
            ...
            boolean _not_7 = (!_is);
            if (_not_7) {
              this.error("This concept is not a role", concept, 
                KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__ROLES, i_3);
              ok = false;
            } else {
        ...
        for (final ConceptDeclaration decl : _conferredTraits) {
          {
            ...
            if (_not_7) {
              this.error("only traits can be conferred by processes or events", concept, 
                KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__CONFERRED_TRAITS, i_4);
            } else {
    ...
    if (_tripleNotEquals_10) {
      if ((((!type.contains(IKimConcept.Type.SUBJECT)) && (!type.contains(IKimConcept.Type.AGENT))) && 
        (!(type.contains(IKimConcept.Type.CONFIGURATION) && concept.isConstitutes())))) {
        ...
        if ((((!type.contains(IKimConcept.Type.CONFIGURATION)) && (!countable.is(IKimConcept.Type.SUBJECT))) && 
          (!countable.is(IKimConcept.Type.AGENT)))) {
          this.error("only subjects can be parts of other subjects", concept, 
            KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__WHOLE);
        } else {
          boolean _isConstituent = concept.isConstituent();
          if (_isConstituent) {
            ret.getConstituentParticipants().add(countable);
          } else {
            boolean _isPartOf = concept.isPartOf();
            if (_isPartOf) {
              ret.getPartParticipants().add(countable);
            } else {
              boolean _isConstitutes = concept.isConstitutes();
              if (_isConstitutes) {
        ...
        for (final ConceptDeclaration decl_1 : _creates) {
          {
            ...
            if (_not_7) {
              this.error(
                "only countable types (subject, event, relationship) can be created by processes or events", concept, KdeclPackage.Literals.CONCEPT_STATEMENT_BODY__CREATES, i_5);
            } else {
    ...
    if (ok) {
      ...
      if ((parent == null)) {
        if ((((type.contains(IKimConcept.Type.QUALITY) && (!concept.isCoreConcept())) && 
          (!type.contains(IKimConcept.Type.NOTHING))) && Kim.intersection(ret.getType(), IKimConcept.QUALITY_TYPES).isEmpty())) {
