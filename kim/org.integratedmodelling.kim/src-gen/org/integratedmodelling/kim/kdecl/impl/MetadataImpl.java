 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.MetadataImpl#getIds <em>Ids</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.MetadataImpl#getValues <em>Values</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.MetadataImpl#getSelectors <em>Selectors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetadataImpl extends DocumentationImpl implements Metadata
{
  ...
  {
    return KdeclPackage.Literals.METADATA;
  }
  ...
  public EList<String> getIds()
  {
    if (ids == null)
    {
      ids = new EDataTypeEList<String>(String.class, this, KdeclPackage.METADATA__IDS);
    }
    return ids;
  }
  ...
  public EList<EObject> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<EObject>(EObject.class, this, KdeclPackage.METADATA__VALUES);
    }
    return values;
  }
  ...
  public EList<DocSelector> getSelectors()
  {
    if (selectors == null)
    {
      selectors = new EObjectContainmentEList<DocSelector>(DocSelector.class, this, KdeclPackage.METADATA__SELECTORS);
    }
    return selectors;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KdeclPackage.METADATA__VALUES:
        return ((InternalEList<?>)getValues()).basicRemove(otherEnd, msgs);
      case KdeclPackage.METADATA__SELECTORS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KdeclPackage.METADATA__IDS:
        return getIds();
      case KdeclPackage.METADATA__VALUES:
        return getValues();
      case KdeclPackage.METADATA__SELECTORS:
