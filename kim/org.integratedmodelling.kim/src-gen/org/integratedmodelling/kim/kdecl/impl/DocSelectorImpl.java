 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.DocSelectorImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.DocSelectorImpl#isDefinition <em>Definition</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.DocSelectorImpl#isInitialization <em>Initialization</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.DocSelectorImpl#isTermination <em>Termination</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.DocSelectorImpl#isTransition <em>Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocSelectorImpl extends MinimalEObjectImpl.Container implements DocSelector
{
  ...
  {
    return KdeclPackage.Literals.DOC_SELECTOR;
  }
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.DOC_SELECTOR__ID, oldId, id));
  }
  ...
  public void setDefinition(boolean newDefinition)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.DOC_SELECTOR__DEFINITION, oldDefinition, definition));
  }
  ...
  public void setInitialization(boolean newInitialization)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.DOC_SELECTOR__INITIALIZATION, oldInitialization, initialization));
  }
  ...
  public void setTermination(boolean newTermination)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.DOC_SELECTOR__TERMINATION, oldTermination, termination));
  }
  ...
  public void setTransition(boolean newTransition)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.DOC_SELECTOR__TRANSITION, oldTransition, transition));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KdeclPackage.DOC_SELECTOR__ID:
        return getId();
      case KdeclPackage.DOC_SELECTOR__DEFINITION:
        return isDefinition();
      case KdeclPackage.DOC_SELECTOR__INITIALIZATION:
        return isInitialization();
      case KdeclPackage.DOC_SELECTOR__TERMINATION:
        return isTermination();
      case KdeclPackage.DOC_SELECTOR__TRANSITION:
        return isTransition();
    }
