 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ListImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListImpl extends MinimalEObjectImpl.Container implements List
{
  ...
  {
    return KdeclPackage.Literals.LIST;
  }
  ...
  public EList<Value> getContents()
  {
    if (contents == null)
    {
      contents = new EObjectContainmentEList<Value>(Value.class, this, KdeclPackage.LIST__CONTENTS);
    }
    return contents;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KdeclPackage.LIST__CONTENTS:
