 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ParameterListImpl#getSingleValue <em>Single Value</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ParameterListImpl#getPairs <em>Pairs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
  ...
  {
    return KdeclPackage.Literals.PARAMETER_LIST;
  }
  ...
  public NotificationChain basicSetSingleValue(Value newSingleValue, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KdeclPackage.PARAMETER_LIST__SINGLE_VALUE, oldSingleValue, newSingleValue);
  ...
  public void setSingleValue(Value newSingleValue)
  {
    if (newSingleValue != singleValue)
    {
      ...
      if (singleValue != null)
        msgs = ((InternalEObject)singleValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KdeclPackage.PARAMETER_LIST__SINGLE_VALUE, null, msgs);
      if (newSingleValue != null)
        msgs = ((InternalEObject)newSingleValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KdeclPackage.PARAMETER_LIST__SINGLE_VALUE, null, msgs);
      msgs = basicSetSingleValue(newSingleValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.PARAMETER_LIST__SINGLE_VALUE, newSingleValue, newSingleValue));
  }
  ...
  public EList<KeyValuePair> getPairs()
  {
    if (pairs == null)
    {
      pairs = new EObjectContainmentEList<KeyValuePair>(KeyValuePair.class, this, KdeclPackage.PARAMETER_LIST__PAIRS);
    }
    return pairs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KdeclPackage.PARAMETER_LIST__SINGLE_VALUE:
        return basicSetSingleValue(null, msgs);
      case KdeclPackage.PARAMETER_LIST__PAIRS:
