 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.NumberImpl#isNegative <em>Negative</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.NumberImpl#getReal <em>Real</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.NumberImpl#isDecimal <em>Decimal</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.NumberImpl#getDecimalPart <em>Decimal Part</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.NumberImpl#isExponential <em>Exponential</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.NumberImpl#isExpNegative <em>Exp Negative</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.NumberImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberImpl extends MinimalEObjectImpl.Container implements org.integratedmodelling.kim.kdecl.Number
{
  /**
  ...
  {
    return KdeclPackage.Literals.NUMBER;
  }
  ...
  public void setNegative(boolean newNegative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.NUMBER__NEGATIVE, oldNegative, negative));
  }
  ...
  public void setReal(int newReal)
  {
    ...
    real = newReal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.NUMBER__REAL, oldReal, real));
  }
  ...
  public void setDecimal(boolean newDecimal)
  {
    ...
    decimal = newDecimal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.NUMBER__DECIMAL, oldDecimal, decimal));
  }
  ...
  public void setDecimalPart(int newDecimalPart)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.NUMBER__DECIMAL_PART, oldDecimalPart, decimalPart));
  }
  ...
  public void setExponential(boolean newExponential)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.NUMBER__EXPONENTIAL, oldExponential, exponential));
  }
  ...
  public void setExpNegative(boolean newExpNegative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.NUMBER__EXP_NEGATIVE, oldExpNegative, expNegative));
  }
  ...
  public void setExp(int newExp)
  {
    ...
    exp = newExp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.NUMBER__EXP, oldExp, exp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KdeclPackage.NUMBER__NEGATIVE:
        return isNegative();
      case KdeclPackage.NUMBER__REAL:
        return getReal();
      case KdeclPackage.NUMBER__DECIMAL:
        return isDecimal();
      case KdeclPackage.NUMBER__DECIMAL_PART:
        return getDecimalPart();
      case KdeclPackage.NUMBER__EXPONENTIAL:
        return isExponential();
      case KdeclPackage.NUMBER__EXP_NEGATIVE:
        return isExpNegative();
      case KdeclPackage.NUMBER__EXP:
        return getExp();
    }
