 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#isDeniable <em>Deniable</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#isSubjective <em>Subjective</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#getAgentSpecifier <em>Agent Specifier</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#getPropertySpecifiers <em>Property Specifiers</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#getConcept <em>Concept</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.ConceptStatementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConceptStatementImpl extends MinimalEObjectImpl.Container implements ConceptStatement
{
  ...
  {
    return KdeclPackage.Literals.CONCEPT_STATEMENT;
  }
  ...
  public EList<Annotation> getAnnotations()
  {
    if (annotations == null)
    {
      annotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, KdeclPackage.CONCEPT_STATEMENT__ANNOTATIONS);
    }
    return annotations;
  }
  ...
  public void setAbstract(boolean newAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.CONCEPT_STATEMENT__ABSTRACT, oldAbstract, abstract_));
  }
  ...
  public void setDeniable(boolean newDeniable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.CONCEPT_STATEMENT__DENIABLE, oldDeniable, deniable));
  }
  ...
  public void setSubjective(boolean newSubjective)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.CONCEPT_STATEMENT__SUBJECTIVE, oldSubjective, subjective));
  }
  ...
  public void setAgentSpecifier(String newAgentSpecifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.CONCEPT_STATEMENT__AGENT_SPECIFIER, oldAgentSpecifier, agentSpecifier));
  }
  ...
  public EList<String> getPropertySpecifiers()
  {
    ...
    {
      propertySpecifiers = new EDataTypeEList<String>(String.class, this, KdeclPackage.CONCEPT_STATEMENT__PROPERTY_SPECIFIERS);
    }
  ...
  public void setConcept(String newConcept)
  {
    ...
    concept = newConcept;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.CONCEPT_STATEMENT__CONCEPT, oldConcept, concept));
  }
  ...
  public NotificationChain basicSetBody(ConceptStatementBody newBody, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KdeclPackage.CONCEPT_STATEMENT__BODY, oldBody, newBody);
  ...
  public void setBody(ConceptStatementBody newBody)
  {
    if (newBody != body)
    {
      ...
      if (body != null)
        msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KdeclPackage.CONCEPT_STATEMENT__BODY, null, msgs);
      if (newBody != null)
        msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KdeclPackage.CONCEPT_STATEMENT__BODY, null, msgs);
      msgs = basicSetBody(newBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.CONCEPT_STATEMENT__BODY, newBody, newBody));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.CONCEPT_STATEMENT__NAME, oldName, name));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KdeclPackage.CONCEPT_STATEMENT__ANNOTATIONS:
        return ((InternalEList<?>)getAnnotations()).basicRemove(otherEnd, msgs);
      case KdeclPackage.CONCEPT_STATEMENT__BODY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case KdeclPackage.CONCEPT_STATEMENT__ABSTRACT:
        return isAbstract();
      case KdeclPackage.CONCEPT_STATEMENT__DENIABLE:
        return isDeniable();
      case KdeclPackage.CONCEPT_STATEMENT__SUBJECTIVE:
        return isSubjective();
      case KdeclPackage.CONCEPT_STATEMENT__AGENT_SPECIFIER:
        return getAgentSpecifier();
      case KdeclPackage.CONCEPT_STATEMENT__PROPERTY_SPECIFIERS:
        return getPropertySpecifiers();
      case KdeclPackage.CONCEPT_STATEMENT__CONCEPT:
        return getConcept();
      case KdeclPackage.CONCEPT_STATEMENT__BODY:
        return getBody();
      case KdeclPackage.CONCEPT_STATEMENT__NAME:
        return getName();
    }
