 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.IdentityRequirementImpl#getIdentities <em>Identities</em>}</li>
 *   <li>{@link org.integratedmodelling.kim.kdecl.impl.IdentityRequirementImpl#getAuthority <em>Authority</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentityRequirementImpl extends MinimalEObjectImpl.Container implements IdentityRequirement
{
  ...
  {
    return KdeclPackage.Literals.IDENTITY_REQUIREMENT;
  }
  ...
  public EList<ConceptDeclaration> getIdentities()
  {
    if (identities == null)
    {
      identities = new EObjectContainmentEList<ConceptDeclaration>(ConceptDeclaration.class, this, KdeclPackage.IDENTITY_REQUIREMENT__IDENTITIES);
    }
    return identities;
  }
  ...
  public void setAuthority(String newAuthority)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KdeclPackage.IDENTITY_REQUIREMENT__AUTHORITY, oldAuthority, authority));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KdeclPackage.IDENTITY_REQUIREMENT__IDENTITIES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case KdeclPackage.IDENTITY_REQUIREMENT__AUTHORITY:
        return getAuthority();
    }
