 ...
 *   <li>{@link org.integratedmodelling.kim.kim.impl.ModelBodyStatementImpl#getObserver <em>Observer</em>}</li>
...
public class ModelBodyStatementImpl extends MinimalEObjectImpl.Container implements ModelBodyStatement
{
  ...
  public NotificationChain basicSetObserver(ConceptDeclaration newObserver, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KimPackage.MODEL_BODY_STATEMENT__OBSERVER, oldObserver, newObserver);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setObserver(ConceptDeclaration newObserver)
  {
    if (newObserver != observer)
    {
      NotificationChain msgs = null;
      if (observer != null)
        msgs = ((InternalEObject)observer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KimPackage.MODEL_BODY_STATEMENT__OBSERVER, null, msgs);
      if (newObserver != null)
        msgs = ((InternalEObject)newObserver).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KimPackage.MODEL_BODY_STATEMENT__OBSERVER, null, msgs);
      msgs = basicSetObserver(newObserver, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KimPackage.MODEL_BODY_STATEMENT__OBSERVER, newObserver, newObserver));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case KimPackage.MODEL_BODY_STATEMENT__OBSERVER:
