...
public class KimPackageImpl extends EPackageImpl implements KimPackage
{
   ...
   * @generated
   */
  private EClass lookupDeclarationEClass = null;
   ...
   */
  @Override
  public EReference getModelBodyStatement_LookupTables()
  {
   ...
   */
  @Override
  public EClass getLookupDeclaration()
  {
    return lookupDeclarationEClass;
  }
   ...
   */
  @Override
  public EReference getLookupDeclaration_LookupTableArgs()
  {
    return (EReference)lookupDeclarationEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getLookupDeclaration_LookupTable()
  {
    return (EReference)lookupDeclarationEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EAttribute getLookupDeclaration_LookupTableId()
  {
    return (EAttribute)lookupDeclarationEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(modelBodyStatementEClass, MODEL_BODY_STATEMENT__LOOKUP_TABLES);
    ...
    lookupDeclarationEClass = createEClass(LOOKUP_DECLARATION);
    createEReference(lookupDeclarationEClass, LOOKUP_DECLARATION__LOOKUP_TABLE_ARGS);
    createEReference(lookupDeclarationEClass, LOOKUP_DECLARATION__LOOKUP_TABLE);
    createEAttribute(lookupDeclarationEClass, LOOKUP_DECLARATION__LOOKUP_TABLE_ID);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getModelBodyStatement_LookupTables(), this.getLookupDeclaration(), null, "lookupTables", null, 0, -1, ModelBodyStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(lookupDeclarationEClass, LookupDeclaration.class, "LookupDeclaration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLookupDeclaration_LookupTableArgs(), this.getLookupTableArgument(), null, "lookupTableArgs", null, 0, -1, LookupDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getLookupDeclaration_LookupTable(), this.getTable(), null, "lookupTable", null, 0, 1, LookupDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getLookupDeclaration_LookupTableId(), ecorePackage.getEString(), "lookupTableId", null, 0, 1, LookupDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
