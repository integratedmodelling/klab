 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kim.kim.impl.MapImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapImpl extends MinimalEObjectImpl.Container implements Map
{
  ...
  {
    return KimPackage.Literals.MAP;
  }
  ...
  public EList<MapEntry> getEntries()
  {
    if (entries == null)
    {
      entries = new EObjectContainmentEList<MapEntry>(MapEntry.class, this, KimPackage.MAP__ENTRIES);
    }
    return entries;
  }
