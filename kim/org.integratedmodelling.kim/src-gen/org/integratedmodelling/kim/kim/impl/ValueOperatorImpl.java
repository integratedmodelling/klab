...
public class ValueOperatorImpl extends MinimalEObjectImpl.Container implements ValueOperator
{
  ...
  {
    return KimPackage.Literals.VALUE_OPERATOR;
  }
  ...
  public void setModifier(String newModifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KimPackage.VALUE_OPERATOR__MODIFIER, oldModifier, modifier));
  }
  ...
  public void setDownTo(String newDownTo)
  {
    ...
    downTo = newDownTo;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KimPackage.VALUE_OPERATOR__DOWN_TO, oldDownTo, downTo));
  }
  ...
  public NotificationChain basicSetComparisonValue(org.integratedmodelling.kim.kim.Number newComparisonValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KimPackage.VALUE_OPERATOR__COMPARISON_VALUE, oldComparisonValue, newComparisonValue);
  ...
  public void setComparisonValue(org.integratedmodelling.kim.kim.Number newComparisonValue)
  {
    if (newComparisonValue != comparisonValue)
    {
      ...
      if (comparisonValue != null)
        msgs = ((InternalEObject)comparisonValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KimPackage.VALUE_OPERATOR__COMPARISON_VALUE, null, msgs);
      if (newComparisonValue != null)
        msgs = ((InternalEObject)newComparisonValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KimPackage.VALUE_OPERATOR__COMPARISON_VALUE, null, msgs);
      msgs = basicSetComparisonValue(newComparisonValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KimPackage.VALUE_OPERATOR__COMPARISON_VALUE, newComparisonValue, newComparisonValue));
  }
  ...
  public NotificationChain basicSetComparisonObservable(ObservableSemantics newComparisonObservable, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KimPackage.VALUE_OPERATOR__COMPARISON_OBSERVABLE, oldComparisonObservable, newComparisonObservable);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setComparisonObservable(ObservableSemantics newComparisonObservable)
  {
    if (newComparisonObservable != comparisonObservable)
    {
      ...
      if (comparisonObservable != null)
        msgs = ((InternalEObject)comparisonObservable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KimPackage.VALUE_OPERATOR__COMPARISON_OBSERVABLE, null, msgs);
      if (newComparisonObservable != null)
        msgs = ((InternalEObject)newComparisonObservable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KimPackage.VALUE_OPERATOR__COMPARISON_OBSERVABLE, null, msgs);
      msgs = basicSetComparisonObservable(newComparisonObservable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KimPackage.VALUE_OPERATOR__COMPARISON_OBSERVABLE, newComparisonObservable, newComparisonObservable));
  }
  ...
  public void setTotal(String newTotal)
  {
    ...
    total = newTotal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KimPackage.VALUE_OPERATOR__TOTAL, oldTotal, total));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KimPackage.VALUE_OPERATOR__MODIFIER:
        return getModifier();
      case KimPackage.VALUE_OPERATOR__DOWN_TO:
        return getDownTo();
      case KimPackage.VALUE_OPERATOR__COMPARISON_VALUE:
