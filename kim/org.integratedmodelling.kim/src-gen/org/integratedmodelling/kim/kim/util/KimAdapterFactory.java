...
public class KimAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected KimSwitch<Adapter> modelSwitch =
    new KimSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseLookupDeclaration(LookupDeclaration object)
      {
        return createLookupDeclarationAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.integratedmodelling.kim.kim.LookupDeclaration <em>Lookup Declaration</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createLookupDeclarationAdapter()
  {
    return null;
  }
