 ...
 *   <li>{@link org.integratedmodelling.kim.kim.ModelBodyStatement#getLookupTables <em>Lookup Tables</em>}</li>
...
public interface ModelBodyStatement extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Lookup Tables</b></em>' containment reference list.
   * The list contents are of type {@link org.integratedmodelling.kim.kim.LookupDeclaration}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Lookup Tables</em>' containment reference list.
   * @see org.integratedmodelling.kim.kim.KimPackage#getModelBodyStatement_LookupTables()
   * @model containment="true"
   * @generated
   */
  EList<LookupDeclaration> getLookupTables();
