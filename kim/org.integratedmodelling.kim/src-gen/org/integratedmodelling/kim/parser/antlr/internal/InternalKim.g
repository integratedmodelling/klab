	...
	(
		...
		(
			...
			(
				...
				this_UrnKvp_12=ruleUrnKvp
				{
					$current.merge(this_UrnKvp_12);
				}
				{
					afterParserOrEnumRuleCall();
				}
			...
			(
				...
				(
					...
					this_Path_14=rulePath
					{
						$current.merge(this_Path_14);
					}
					{
						afterParserOrEnumRuleCall();
					}
					...
					this_UrnKvp_15=ruleUrnKvp
					{
						$current.merge(this_UrnKvp_15);
					}
					{
						afterParserOrEnumRuleCall();
					}
