	...
	(
		...
		(
			(
				...
				(
					(
						{
							newCompositeNode(grammarAccess.getModelBodyStatementAccess().getLookupTablesLookupDeclarationParserRuleCall_7_0_1_0());
						}
						lv_lookupTables_29_0=ruleLookupDeclaration
						{
							if ($current==null) {
								$current = createModelElementForParent(grammarAccess.getModelBodyStatementRule());
							}
							add(
								$current,
								"lookupTables",
								lv_lookupTables_29_0,
								"org.integratedmodelling.kim.Kim.LookupDeclaration");
							afterParserOrEnumRuleCall();
						}
					)
				)
				(
					otherlv_30=','
					{
						newLeafNode(otherlv_30, grammarAccess.getModelBodyStatementAccess().getCommaKeyword_7_0_2_0());
					}
					(
						(
							{
								newCompositeNode(grammarAccess.getModelBodyStatementAccess().getLookupTablesLookupDeclarationParserRuleCall_7_0_2_1_0());
							}
							lv_lookupTables_31_0=ruleLookupDeclaration
							{
								if ($current==null) {
									$current = createModelElementForParent(grammarAccess.getModelBodyStatementRule());
								}
			...
			(
				(
					(
						lv_twoway_32_0='match'
						{
							newLeafNode(lv_twoway_32_0, grammarAccess.getModelBodyStatementAccess().getTwowayMatchKeyword_7_1_0_0());
						}
						{
							if ($current==null) {
								$current = createModelElement(grammarAccess.getModelBodyStatementRule());
							}
							setWithLastConsumed($current, "twoway", lv_twoway_32_0 != null, "match");
						}
					)
				)
				(
					otherlv_33='('
					{
						newLeafNode(otherlv_33, grammarAccess.getModelBodyStatementAccess().getLeftParenthesisKeyword_7_1_1_0());
					}
					(
						(
							{
							...
							lv_lookupTableArgs_34_0=ruleLookupTableArgumentQualified
							{
								if ($current==null) {
									$current = createModelElementForParent(grammarAccess.getModelBodyStatementRule());
								}
					...
					otherlv_35=','
					{
						newLeafNode(otherlv_35, grammarAccess.getModelBodyStatementAccess().getCommaKeyword_7_1_1_2());
					}
					(
						(
							{
							...
							lv_lookupTableArgs_36_0=ruleLookupTableArgumentQualified
							{
								if ($current==null) {
									$current = createModelElementForParent(grammarAccess.getModelBodyStatementRule());
								}
					...
					otherlv_37=')'
					{
						newLeafNode(otherlv_37, grammarAccess.getModelBodyStatementAccess().getRightParenthesisKeyword_7_1_1_4());
					}
				)?
				otherlv_38='to'
				{
					newLeafNode(otherlv_38, grammarAccess.getModelBodyStatementAccess().getToKeyword_7_1_2());
				}
				(
					(
						(
							...
							lv_lookupTable_39_0=ruleTwoWayTable
							{
								if ($current==null) {
									$current = createModelElementForParent(grammarAccess.getModelBodyStatementRule());
								}
					...
					(
						(
							lv_lookupTableId_40_0=RULE_UPPERCASE_ID
							{
								newLeafNode(lv_lookupTableId_40_0, grammarAccess.getModelBodyStatementAccess().getLookupTableIdUPPERCASE_IDTerminalRuleCall_7_1_3_1_0());
							}
							{
								if ($current==null) {
									$current = createModelElement(grammarAccess.getModelBodyStatementRule());
		...
		(
			(
				...
				lv_actions_41_0=ruleActionSpecification
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getModelBodyStatementRule());
					}
		...
		(
			otherlv_42='metadata'
			{
				newLeafNode(otherlv_42, grammarAccess.getModelBodyStatementAccess().getMetadataKeyword_9_0());
			}
			(
				(
					{
...
// Entry rule entryRuleLookupDeclaration
entryRuleLookupDeclaration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLookupDeclarationRule()); }
	iv_ruleLookupDeclaration=ruleLookupDeclaration
	{ $current=$iv_ruleLookupDeclaration.current; }
	EOF;

// Rule LookupDeclaration
ruleLookupDeclaration returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			otherlv_0='('
			{
				newLeafNode(otherlv_0, grammarAccess.getLookupDeclarationAccess().getLeftParenthesisKeyword_0_0());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getLookupDeclarationAccess().getLookupTableArgsLookupTableArgumentParserRuleCall_0_1_0());
					}
					lv_lookupTableArgs_1_0=ruleLookupTableArgument
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getLookupDeclarationRule());
						}
						add(
							$current,
							"lookupTableArgs",
							lv_lookupTableArgs_1_0,
			...
			(
				otherlv_2=','
				{
					newLeafNode(otherlv_2, grammarAccess.getLookupDeclarationAccess().getCommaKeyword_0_2_0());
				}
				(
					(
						{
							newCompositeNode(grammarAccess.getLookupDeclarationAccess().getLookupTableArgsLookupTableArgumentParserRuleCall_0_2_1_0());
						}
						lv_lookupTableArgs_3_0=ruleLookupTableArgument
						{
							if ($current==null) {
								$current = createModelElementForParent(grammarAccess.getLookupDeclarationRule());
							}
			...
			otherlv_4=')'
			{
				newLeafNode(otherlv_4, grammarAccess.getLookupDeclarationAccess().getRightParenthesisKeyword_0_3());
			}
		)?
		otherlv_5='into'
		{
			newLeafNode(otherlv_5, grammarAccess.getLookupDeclarationAccess().getIntoKeyword_1());
		}
		(
			(
				(
					{
						newCompositeNode(grammarAccess.getLookupDeclarationAccess().getLookupTableTableParserRuleCall_2_0_0());
					}
					lv_lookupTable_6_0=ruleTable
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getLookupDeclarationRule());
						}
			...
			(
				(
					lv_lookupTableId_7_0=RULE_UPPERCASE_ID
					{
						newLeafNode(lv_lookupTableId_7_0, grammarAccess.getLookupDeclarationAccess().getLookupTableIdUPPERCASE_IDTerminalRuleCall_2_1_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getLookupDeclarationRule());
						}
						setWithLastConsumed(
							$current,
							"lookupTableId",
							lv_lookupTableId_7_0,
							"org.integratedmodelling.kim.Kim.UPPERCASE_ID");
					}
				)
			)
