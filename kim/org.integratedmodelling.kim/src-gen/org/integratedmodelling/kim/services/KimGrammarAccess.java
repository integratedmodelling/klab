...
public class KimGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class NamespaceElements extends AbstractParserRuleElementFinder {
		...
		//	(('using' 'language' language=UPPERCASE_ID)? & ('using' imported+=Import (=> ',' imported+=Import)*)? & ('imports'
	...
	public class ObservableSemanticsElements extends AbstractParserRuleElementFinder {
		...
		//	'per' unit=Unit)? & (valueOperators+=ValueOperator valueOperators+=ValueOperator*)? & (optional?='optional' |
		//	'required')? & (from=Number 'to' to=Number)? & ('named' name=(LOWERCASE_ID | STRING))?);
		@Override public ParserRule getRule() { return rule; }
		
		//(value=Value 'as')? generic?='any'? declaration=ConceptDeclaration (('according' 'to' accordingTo=PropertyId)? & ('in'
		//(unit=Unit | currency=Currency) | 'per' unit=Unit)? & (valueOperators+=ValueOperator valueOperators+=ValueOperator*)?
		...
		//'to' to=Number)? & ('named' name=(LOWERCASE_ID | STRING))?
	...
	public class ValueOperatorElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cComparisonConceptAssignment_0_1_1 = (Assignment)cAlternatives_0_1.eContents().get(1);
		private final RuleCall cComparisonConceptConceptDeclarationParserRuleCall_0_1_1_0 = (RuleCall)cComparisonConceptAssignment_0_1_1.eContents().get(0);
		...
		private final Assignment cComparisonObservableAssignment_0_1_2_1 = (Assignment)cGroup_0_1_2.eContents().get(1);
		private final RuleCall cComparisonObservableObservableSemanticsParserRuleCall_0_1_2_1_0 = (RuleCall)cComparisonObservableAssignment_0_1_2_1.eContents().get(0);
		...
		//ValueOperator:
		//	(modifier=VALUE_OPERATOR | downTo='down' 'to') (comparisonValue=Number | comparisonConcept=ConceptDeclaration | '('
		//	comparisonObservable=ObservableSemantics ')') | total='total';
		@Override public ParserRule getRule() { return rule; }
		...
		public Assignment getComparisonConceptAssignment_0_1_1() { return cComparisonConceptAssignment_0_1_1; }
		
		//ConceptDeclaration
		public RuleCall getComparisonConceptConceptDeclarationParserRuleCall_0_1_1_0() { return cComparisonConceptConceptDeclarationParserRuleCall_0_1_1_0; }
		...
		//comparisonObservable=ObservableSemantics
		public Assignment getComparisonObservableAssignment_0_1_2_1() { return cComparisonObservableAssignment_0_1_2_1; }
		
		//ObservableSemantics
		public RuleCall getComparisonObservableObservableSemanticsParserRuleCall_0_1_2_1_0() { return cComparisonObservableObservableSemanticsParserRuleCall_0_1_2_1_0; }
	...
	public class AnnotatedObservableSemanticsElements extends AbstractParserRuleElementFinder {
		...
		//annotations+=Annotation* (value=Value 'as')? generic?='any'? declaration=ConceptDeclaration (('according' 'to'
		//accordingTo=PropertyId)? & ('in' (unit=Unit | currency=Currency) | 'per' unit=Unit)? & (valueOperators+=ValueOperator
		//valueOperators+=ValueOperator*)? & (optional?='optional' | 'required')? & (from=Number 'to' to=Number)? & ('named'
		//name=(LOWERCASE_ID | STRING))?)
		public Group getGroup() { return cGroup; }
	...
	public class ConceptStatementBodyElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cUsesKeyword_3_21_0 = (Keyword)cGroup_3_21.eContents().get(0);
		private final Keyword cAuthorityKeyword_3_21_1 = (Keyword)cGroup_3_21.eContents().get(1);
		private final Assignment cAuthoritiesAssignment_3_21_2 = (Assignment)cGroup_3_21.eContents().get(2);
		private final Alternatives cAuthoritiesAlternatives_3_21_2_0 = (Alternatives)cAuthoritiesAssignment_3_21_2.eContents().get(0);
		private final RuleCall cAuthoritiesUPPERCASE_IDTerminalRuleCall_3_21_2_0_0 = (RuleCall)cAuthoritiesAlternatives_3_21_2_0.eContents().get(0);
		private final RuleCall cAuthoritiesUPPERCASE_PATHTerminalRuleCall_3_21_2_0_1 = (RuleCall)cAuthoritiesAlternatives_3_21_2_0.eContents().get(1);
		...
		private final Assignment cPropertiesAssignment_3_23 = (Assignment)cUnorderedGroup_3.eContents().get(23);
		private final RuleCall cPropertiesPropertyStatementParserRuleCall_3_23_0 = (RuleCall)cPropertiesAssignment_3_23.eContents().get(0);
		...
		//	'children' children+=ChildConcept (',' children+=ChildConcept)*)? & ('uses' 'authority' authorities+=(UPPERCASE_ID |
		//	UPPERCASE_PATH))? & ('metadata' metadata=Metadata)? & properties+=PropertyStatement*);
		@Override public ParserRule getRule() { return rule; }
		...
		//'uses'
		public Keyword getUsesKeyword_3_21_0() { return cUsesKeyword_3_21_0; }
		
		//'authority'
		public Keyword getAuthorityKeyword_3_21_1() { return cAuthorityKeyword_3_21_1; }
		
		//authorities+=(UPPERCASE_ID | UPPERCASE_PATH)
		public Assignment getAuthoritiesAssignment_3_21_2() { return cAuthoritiesAssignment_3_21_2; }
		
		//(UPPERCASE_ID | UPPERCASE_PATH)
		public Alternatives getAuthoritiesAlternatives_3_21_2_0() { return cAuthoritiesAlternatives_3_21_2_0; }
		
		//UPPERCASE_ID
		public RuleCall getAuthoritiesUPPERCASE_IDTerminalRuleCall_3_21_2_0_0() { return cAuthoritiesUPPERCASE_IDTerminalRuleCall_3_21_2_0_0; }
		
		//UPPERCASE_PATH
		public RuleCall getAuthoritiesUPPERCASE_PATHTerminalRuleCall_3_21_2_0_1() { return cAuthoritiesUPPERCASE_PATHTerminalRuleCall_3_21_2_0_1; }
		...
		public Assignment getPropertiesAssignment_3_23() { return cPropertiesAssignment_3_23; }
		
		//PropertyStatement
		public RuleCall getPropertiesPropertyStatementParserRuleCall_3_23_0() { return cPropertiesPropertyStatementParserRuleCall_3_23_0; }
	}
	public class PropertyStatementElements extends AbstractParserRuleElementFinder {
		...
		//PropertyStatement:
		//	(property=(PropertyId | BACKCASE_ID) | has?='has' | contains?='contains' | uses?='uses') (only?='only' |
		...
		//(only?='only' | (exactly?='exactly' | 'at' (atLeast?='least' | atMost?='most'))? cardinality=INT ('or'
		//orMore?='more')?)?
		public Alternatives getAlternatives_1() { return cAlternatives_1; }
	...
	public class ValueWithIdAndConceptElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cQuantityAssignment_8 = (Assignment)cAlternatives.eContents().get(8);
		private final RuleCall cQuantityQuantityParserRuleCall_8_0 = (RuleCall)cQuantityAssignment_8.eContents().get(0);
		...
		//	UPPERCASE_ID | CAMELCASE_ID) | list=List | table=LookupTable | map=Map | quantity=Quantity | null?='unknown';
		@Override public ParserRule getRule() { return rule; }
		...
		//Quantity
		public RuleCall getQuantityQuantityParserRuleCall_8_0() { return cQuantityQuantityParserRuleCall_8_0; }
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		...
		//Value:
		//	literal=LiteralOrIdOrComma | function=Function | expr=EXPR ('in' language=UPPERCASE_ID)? | id=(LOWERCASE_ID |
		//	UPPERCASE_ID | CAMELCASE_ID) | list=List | table=LookupTable | quantity=Quantity | map=Map | null?='unknown';
		@Override public ParserRule getRule() { return rule; }
	...
	public class LiteralValueWithConceptElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cIdUPPERCASE_IDTerminalRuleCall_5_0_1 = (RuleCall)cIdAlternatives_5_0.eContents().get(1);
		private final RuleCall cIdCAMELCASE_IDTerminalRuleCall_5_0_2 = (RuleCall)cIdAlternatives_5_0.eContents().get(2);
		
		//// value for 'value as observable' idioms
		//LiteralValueWithConcept Value:
		//	literal=Literal | concept=ConceptDeclaration | function=Function | expr=EXPR | quantity=Quantity | id=(LOWERCASE_ID |
		//	UPPERCASE_ID | CAMELCASE_ID);
		@Override public ParserRule getRule() { return rule; }
		...
		//UPPERCASE_ID
		public RuleCall getIdUPPERCASE_IDTerminalRuleCall_5_0_1() { return cIdUPPERCASE_IDTerminalRuleCall_5_0_1; }
		
		//CAMELCASE_ID
		public RuleCall getIdCAMELCASE_IDTerminalRuleCall_5_0_2() { return cIdCAMELCASE_IDTerminalRuleCall_5_0_2; }
	}
	...
	public class DependencyObservableSemanticsElements extends AbstractParserRuleElementFinder {
		...
		//(value=LiteralValueWithConcept 'as')? generic?='any'? declaration=ConceptDeclaration (('according' 'to'
		//accordingTo=PropertyId)? & ('in' (unit=Unit | currency=Currency) | 'per' unit=Unit)? & (from=Number 'to' to=Number)? &
		//(valueOperators+=ValueOperator valueOperators+=ValueOperator*)? & (optional?='optional' | 'required')? & ('named'
		//name=(LOWERCASE_ID | STRING))?)
		public Group getGroup() { return cGroup; }
	...
	public class AlternativeDependencyObservableSemanticsElements extends AbstractParserRuleElementFinder {
		...
		//(value=LiteralValueWithConcept 'as')? generic?='any'? declaration=ConceptDeclaration (('according' 'to'
		//accordingTo=PropertyId)? & ('in' (unit=Unit | currency=Currency) | 'per' unit=Unit)? & (from=Number 'to' to=Number)? &
		//(valueOperators+=ValueOperator valueOperators+=ValueOperator*)?) ('if' condition=EXPR)?
		public Group getGroup() { return cGroup; }
		...
		//('according' 'to' accordingTo=PropertyId)? & ('in' (unit=Unit | currency=Currency) | 'per' unit=Unit)? & (from=Number
		//'to' to=Number)? & (valueOperators+=ValueOperator valueOperators+=ValueOperator*)?
		public UnorderedGroup getUnorderedGroup_3() { return cUnorderedGroup_3; }
