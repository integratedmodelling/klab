...
public class KimGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelBodyStatementElements extends AbstractParserRuleElementFinder {
		...
		//	'into' (lookupTable=Table | lookupTableId=UPPERCASE_ID) | twoway?='match' ('('
		//	lookupTableArgs+=LookupTableArgumentQualified ',' lookupTableArgs+=LookupTableArgumentQualified ')')?
		//	'to' (lookupTable=TwoWayTable | lookupTableId=UPPERCASE_ID))?
		...
		//contextualizers+=ValueExecution)*)? (('classified' | discretization?='discretized') ('into'
		//classification=Classification | 'according' 'to' classificationProperty=PropertyId))? ('lookup' ('('
		//lookupTableArgs+=LookupTableArgument (',' lookupTableArgs+=LookupTableArgument)* ')')? 'into' (lookupTable=Table |
		//lookupTableId=UPPERCASE_ID) | twoway?='match' ('(' lookupTableArgs+=LookupTableArgumentQualified ','
		//lookupTableArgs+=LookupTableArgumentQualified ')')? 'to' (lookupTable=TwoWayTable | lookupTableId=UPPERCASE_ID))?
		//actions+=ActionSpecification* ('metadata' metadata=Map)?
		public Group getGroup() { return cGroup; }
		...
		//('lookup' ('(' lookupTableArgs+=LookupTableArgument (',' lookupTableArgs+=LookupTableArgument)* ')')? 'into'
		//(lookupTable=Table | lookupTableId=UPPERCASE_ID) | twoway?='match' ('(' lookupTableArgs+=LookupTableArgumentQualified
		//',' lookupTableArgs+=LookupTableArgumentQualified ')')? 'to' (lookupTable=TwoWayTable | lookupTableId=UPPERCASE_ID))?
		...
		//twoway?='match' ('(' lookupTableArgs+=LookupTableArgumentQualified ',' lookupTableArgs+=LookupTableArgumentQualified
		//')')? 'to' (lookupTable=TwoWayTable | lookupTableId=UPPERCASE_ID)
	...
	public class LookupTableArgumentElements extends AbstractParserRuleElementFinder {
		...
		//LookupTableArgument:
		//	id=(LOWERCASE_ID | '?' | '*') | concept=ConceptDeclaration;
		@Override public ParserRule getRule() { return rule; }
	...
	public class LookupTableArgumentQualifiedElements extends AbstractParserRuleElementFinder {
		...
		//LookupTableArgumentQualified LookupTableArgument:
		//	(key=('column' | 'row') '=')? id=LOWERCASE_ID | (key=('column' | 'row') '=')? concept=ConceptDeclaration;
		@Override public ParserRule getRule() { return rule; }
	...
	public class ClassifierRHSWithIdNoSetElements extends AbstractParserRuleElementFinder {
		...
		//ClassifierRHSWithIdNoSet ClassifierRHS:
		//	(boolean='true' | boolean='false') | int0=Number (leftLimit='inclusive' | 'exclusive')? => 'to' => int1=Number
		//	(rightLimit='inclusive' | 'exclusive')? | num=Number | string=STRING | concept=ConceptDeclaration | id=(LOWERCASE_ID
		//	| PropertyId) | op=REL_OPERATOR expression=Number | nodata='unknown' | star?='*';
		@Override public ParserRule getRule() { return rule; }
	...
	public class LookupTableElements extends AbstractParserRuleElementFinder {
		...
		//{LookupTable} '{{' table=(Table | TwoWayTable)? '}}'
		public Group getGroup() { return cGroup; }
	...
	public class TableClassifierElements extends AbstractParserRuleElementFinder {
		...
		//	(boolean='true' | boolean='false') | int0=Number (leftLimit='inclusive' | 'exclusive')? => 'to' => int1=Number
		//	(rightLimit='inclusive' | 'exclusive')? | num=Number | quantity=Quantity | date=Date |
		...
		//(boolean='true' | boolean='false') | int0=Number (leftLimit='inclusive' | 'exclusive')? => 'to' => int1=Number
		//(rightLimit='inclusive' | 'exclusive')? | num=Number | quantity=Quantity | date=Date | 'in' set=List | string=STRING |
	...
	public class ObservableSemanticsElements extends AbstractParserRuleElementFinder {
		...
		//(value=Value 'as')? generic?='any'? declaration=ConceptDeclaration (('according' 'to' accordingTo=PropertyId)? & (=>
	...
	public class ConceptReferenceElements extends AbstractParserRuleElementFinder {
		...
		//ConceptReference:
		//	name=AuthorityId | name=CAMELCASE_ID | name=NamespaceId | templateType=('${' | '#{') (name='context'
		//	(type=CONCEPT_TYPE | 'extends' extends=Concept) | name='inherent' (type=CONCEPT_TYPE | 'extends' extends=Concept) |
		//	name='compresent' (type=CONCEPT_TYPE | 'extends' extends=Concept) | name='adjacent' (type=CONCEPT_TYPE | 'extends'
		//	extends=Concept) | name='container' (type=CONCEPT_TYPE | 'extends' extends=Concept) | name='contained'
		//	(type=CONCEPT_TYPE | 'extends' extends=Concept) | name='purpose' (type=CONCEPT_TYPE | 'extends' extends=Concept) |
		//	name='causant' (type=CONCEPT_TYPE | 'extends' extends=Concept) | name='caused' (type=CONCEPT_TYPE | 'extends'
		//	extends=Concept) | name='cooccurrent' (type=CONCEPT_TYPE | 'extends' extends=Concept)) template?='}';
		@Override public ParserRule getRule() { return rule; }
		
		//name=AuthorityId | name=CAMELCASE_ID | name=NamespaceId | templateType=('${' | '#{') (name='context' (type=CONCEPT_TYPE
		//| 'extends' extends=Concept) | name='inherent' (type=CONCEPT_TYPE | 'extends' extends=Concept) | name='compresent'
	...
	public class ConceptElements extends AbstractParserRuleElementFinder {
		...
		//	(change?='in' | rate?='rate' 'of') | changed?='changed') concept=SimpleConceptDeclaration |
		...
		//distance?='distance' ('to' | 'from') concept=SimpleConceptDeclaration | probability?='probability' 'of'
		//concept=SimpleConceptDeclaration | assessment?='assessment' 'of' concept=SimpleConceptDeclaration | ('change'
		//(change?='in' | rate?='rate' 'of') | changed?='changed') concept=SimpleConceptDeclaration | uncertainty?='uncertainty'
	...
	public class QuantificationElements extends AbstractParserRuleElementFinder {
		...
		//Quantification:
		//	{Quantification} (only?='only' | (exactly?='exactly' | 'at' (atLeast?='least' | atMost?='most'))? cardinality=INT
		//	('or' orMore?='more')?)?;
		@Override public ParserRule getRule() { return rule; }
		
		//{Quantification} (only?='only' | (exactly?='exactly' | 'at' (atLeast?='least' | atMost?='most'))? cardinality=INT ('or'
		//orMore?='more')?)?
		public Group getGroup() { return cGroup; }
	...
	public class ValueWithIdAndConceptElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cMapAssignment_1 = (Assignment)cAlternatives.eContents().get(1);
		private final RuleCall cMapMapParserRuleCall_1_0 = (RuleCall)cMapAssignment_1.eContents().get(0);
		private final Assignment cConceptAssignment_2 = (Assignment)cAlternatives.eContents().get(2);
		private final RuleCall cConceptSimpleObservableSemanticsParserRuleCall_2_0 = (RuleCall)cConceptAssignment_2.eContents().get(0);
		...
		private final Assignment cDateAssignment_4 = (Assignment)cAlternatives.eContents().get(4);
		private final RuleCall cDateDateParserRuleCall_4_0 = (RuleCall)cDateAssignment_4.eContents().get(0);
		private final Assignment cLiteralAssignment_5 = (Assignment)cAlternatives.eContents().get(5);
		...
		//	list=List | map=Map | concept=SimpleObservableSemantics | function=Function | date=Date | literal=Literal | expr=EXPR
		//	| id=(PathName | LOWERCASE_ID | UPPERCASE_ID | CAMELCASE_ID) | table=LookupTable | quantity=Quantity |
		//	op=REL_OPERATOR expression=Number | null?='unknown';
		@Override public ParserRule getRule() { return rule; }
		
		//list=List | map=Map | concept=SimpleObservableSemantics | function=Function | date=Date | literal=Literal | expr=EXPR |
		//id=(PathName | LOWERCASE_ID | UPPERCASE_ID | CAMELCASE_ID) | table=LookupTable | quantity=Quantity | op=REL_OPERATOR
		//expression=Number | null?='unknown'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//Map
		public RuleCall getMapMapParserRuleCall_1_0() { return cMapMapParserRuleCall_1_0; }
		
		//concept=SimpleObservableSemantics
		public Assignment getConceptAssignment_2() { return cConceptAssignment_2; }
		
		//SimpleObservableSemantics
		public RuleCall getConceptSimpleObservableSemanticsParserRuleCall_2_0() { return cConceptSimpleObservableSemanticsParserRuleCall_2_0; }
