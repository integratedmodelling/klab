...
public abstract class AbstractKimSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == KimPackage.eINSTANCE)
			...
			case KimPackage.LOOKUP_DECLARATION:
				sequence_LookupDeclaration(context, (LookupDeclaration) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     LookupDeclaration returns LookupDeclaration
	 *
	 * Constraint:
	 *     ((lookupTableArgs+=LookupTableArgument lookupTableArgs+=LookupTableArgument*)? (lookupTable=Table | lookupTableId=UPPERCASE_ID))
	 * </pre>
	 */
	protected void sequence_LookupDeclaration(ISerializationContext context, LookupDeclaration semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *         (
	 *             (lookupTables+=LookupDeclaration lookupTables+=LookupDeclaration*) | 
	 *             (
	 *                 twoway?='match' 
