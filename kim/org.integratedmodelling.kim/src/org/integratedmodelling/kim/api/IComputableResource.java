...
/**
 * A computable resource is a declaration that specifies a processing step for a dataflow. In k.IM
 * this can be represented by:
 * <p>
 * <ul>
 * <li>a literal value;</li>
 * <li>the URN for a data source or computation;</li>
 * <li>a service call;</li>
 * <li>an executable expression in a supported language;</li>
 * <li>a classification or lookup table;</li>
 * </ul>
 * <p>
 * It is the runtime's task to turn any computable resource into a uniform service call, which can
 * later produce a IContextualizer to be inserted in a dataflow.
 * 
 * @author Ferd
 *
 */
public interface IComputableResource {
  ...
  /**
   * A URN specifying a remote computation. Only one among getLiteral(), getServiceCall(), getUrn()
   * and getExpression() will return a non-null value.
   * 
   * @return
   */
  String getUrn();
