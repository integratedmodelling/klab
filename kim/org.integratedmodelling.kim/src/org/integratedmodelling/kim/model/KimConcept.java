...
public class KimConcept extends KimStatement implements IKimConcept {
    ...
    /**
     * Create a normalized KimConcept from a parsed declaration, optionally using
     * a macro instance for substitutions.
     * 
     * @param declaration
        ...
        if (concept.getConcept() != null) {
            ...
            if (concept.getName().isTemplate()) {
                ...
                if (ret.name != null && !ret.name.contains(":")) {
                    ...
                    ret.name = (namespace == null ? "UNDEFINED" : namespace.getName()) + ":" + ret.name;
                }
            }
    ...
    @Override
    public KimConcept getByTrait() {
        return byTrait;
    }

    public void setByTrait(KimConcept byTrait) {
        this.byTrait = byTrait;
    }

    @Override
    public KimConcept getDownTo() {
        return downTo;
    }

    public void setDownTo(KimConcept downTo) {
        this.downTo = downTo;
    }
    ...
    /**
     * Call to check if the declaration defines an abstract status. Returns
     * the type for fluency.
     * 
