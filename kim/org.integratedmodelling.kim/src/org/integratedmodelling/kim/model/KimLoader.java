...
/**
 * TODO loaders must subscribe with Kim, so that reloads changes initiated by external code (e.g. Eclipse builders) will pick up the changes and recompute the dependency graph.
 * @author Ferd
 *
 */
public class KimLoader implements IKimLoader {
    ...
    @Override
    public void reload() {
        // TODO remove anyth NsInfo that's not external AND whose file has time of update > the namespace's.
