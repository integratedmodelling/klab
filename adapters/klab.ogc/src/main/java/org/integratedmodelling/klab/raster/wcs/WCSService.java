        ...
        class Band {
            public Band(Map<?, ?> data) {
                ...
                if (quantity.containsKey("constraint")) {
                    double[] nils = NumberUtils.doubleArrayFromString(((Map<?, ?>) quantity).get("constraint").toString(),
                            "\\s+");
                    ...
                    if (quantity.containsKey("nilValues")) {
                        // read the nodata value from nilValues, which unfortunately contains a null
                        // key
                ...
                try {
                    ...
                    if (coverage == null) {
                        try (InputStream input = url.openStream()) {
                            coverage = (Map<?, ?>) parser.parse(input);
