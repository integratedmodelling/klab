...
public class SemanticServerStartupOptions implements ISemanticServerStartupOptions {
    ...
    @Option(
            name = "-cert",
            usage = "certificate file (default: <dataDir>/" + ICertificate.DEFAULT_SEMANTIC_SERVER_CERTIFICATE_FILENAME + ")",
            metaVar = "<FILE_PATH>")
     ...
     * All defaults
     */
    public SemanticServerStartupOptions() {
    }

    public SemanticServerStartupOptions(String... args) {
    	initialize(args);
    }
    ...
    public File getCertificateFile() {
        if (certificateFile == null) {
            certificateFile = new File(Configuration.INSTANCE.getDataPath() + File.separator + ICertificate.DEFAULT_SEMANTIC_SERVER_CERTIFICATE_FILENAME);
        }
        return certificateFile;
    }

    public static void main(String args[]) {
        System.out.println(new SemanticServerStartupOptions().usage());
    }
