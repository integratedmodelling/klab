	...
	public Collection<Pair<KConcept, Property>> getObjectRestrictions() {
		...
		for (OWLQuantifiedRestriction<?, ?, ?> r : getRestrictions().getObjectRestrictions()) {
			...
			OWLObjectPropertyExpression zz = ((OWLRestriction<?, ? extends OWLObjectPropertyExpression, ?>) r)
					.getProperty();
			ret.add(new Pair<KConcept, Property>(OWL.INSTANCE.getExistingOrCreate(filler), new Property(
...
//	@Override
	...
	public int getSemanticDistance(KConcept concept, KConcept context, boolean compareInherency,
		...
		component = getDistance(reasoner.goal(this), reasoner.goal(concept),
				false);
		...
		component = getDistance(reasoner.cooccurrent(this),
				reasoner.cooccurrent(concept), false);
		...
		component = getDistance(reasoner.causant(this), reasoner.causant(concept),
				false);
		...
		component = getDistance(reasoner.caused(this), reasoner.caused(concept),
				false);
		...
		component = getDistance(reasoner.adjacent(this),
		        reasoner.adjacent(concept), false);
		...
		component = getDistance(reasoner.compresent(this),
		        reasoner.compresent(concept), false);
		...
		component = getDistance(reasoner.relativeTo(this),
		        reasoner.relativeTo(concept), false);
	...
	public int getCoreDistance(KConcept concept, KConcept context, boolean compareInherency,
		 ...
		 * identity.
		 */
		return core1.equals(core2) ? reasoner.assertedDistance(this, concept)
