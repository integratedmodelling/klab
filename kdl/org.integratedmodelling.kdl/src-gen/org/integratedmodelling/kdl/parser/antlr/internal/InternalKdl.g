	...
	(
		(
			...
			(
				...
				(
					(
						lv_localName_20_0=RULE_LOWERCASE_ID
						{
		...
		(
			...
			(
				(
					(
						lv_name_28_1=RULE_LOWERCASE_ID
						{
						...
						}
						{
						    ...
						    |
						lv_name_28_2=RULE_LOWERCASE_DASHID
						{
			...
			(
				...
				(
					(
						lv_enumValues_30_0=RULE_UPPERCASE_ID
						{
				...
				(
					...
					(
						(
							lv_enumValues_32_0=RULE_UPPERCASE_ID
							{
