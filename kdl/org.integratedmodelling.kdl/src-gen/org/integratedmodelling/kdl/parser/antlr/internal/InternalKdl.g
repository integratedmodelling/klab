...
@after {
	...
	(
		...
		(
			(
				(
					lv_name_13_1=RULE_LOWERCASE_ID
					{
					...
					}
					{
					    ...
					    |
					lv_name_13_2=RULE_LOWERCASE_DASHID
					{
		...
		(
			...
			(
				(
					(
						lv_extended_15_1=RULE_LOWERCASE_ID
						{
		...
		(
			...
			(
				(
					lv_localName_41_0=RULE_LOWERCASE_ID
					{
