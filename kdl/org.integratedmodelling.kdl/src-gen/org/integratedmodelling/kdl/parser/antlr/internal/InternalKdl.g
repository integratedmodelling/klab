	...
	(
		(
			...
			(
				...
				(
					(
						lv_localName_24_0=RULE_LOWERCASE_ID
						{
		...
		(
			...
			(
				(
					(
						lv_name_33_1=RULE_LOWERCASE_ID
						{
						...
						}
						{
						    ...
						    |
						lv_name_33_2=RULE_LOWERCASE_DASHID
						{
			...
			(
				...
				(
					...
					(
						(
							lv_enumValues_37_0=RULE_UPPERCASE_ID
							{
