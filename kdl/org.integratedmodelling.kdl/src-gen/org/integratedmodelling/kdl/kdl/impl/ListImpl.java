 ...
 * </p>
 * <ul>
 *   <li>{@link org.integratedmodelling.kdl.kdl.impl.ListImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListImpl extends MinimalEObjectImpl.Container implements List
{
  ...
  {
    return KdlPackage.Literals.LIST;
  }
  ...
  public EList<Value> getContents()
  {
    if (contents == null)
    {
      contents = new EObjectContainmentEList<Value>(Value.class, this, KdlPackage.LIST__CONTENTS);
    }
    return contents;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KdlPackage.LIST__CONTENTS:
