...
public interface DataflowBody extends EObject
{
   ...
   * @see #setUnits(Unit)
   * @see org.integratedmodelling.kdl.kdl.KdlPackage#getDataflowBody_Units()
   * @model containment="true"
   * @generated
   */
  Unit getUnits();
  ...
  /**
   * Sets the value of the '{@link org.integratedmodelling.kdl.kdl.DataflowBody#getUnits <em>Units</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
