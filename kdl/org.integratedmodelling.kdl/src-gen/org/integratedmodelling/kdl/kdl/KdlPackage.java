...
public interface KdlPackage extends EPackage
{
   ...
   * @ordered
   */
  int ACTOR_DEFINITION__ANNOTATIONS = 0;
   ...
   * @ordered
   */
  int ACTOR_DEFINITION__ABSTRACT = 1;
