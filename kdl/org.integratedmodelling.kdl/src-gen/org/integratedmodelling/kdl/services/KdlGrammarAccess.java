...
public class KdlGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ACTORElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cResolveKeyword_15 = (Keyword)cAlternatives.eContents().get(15);
		...
		//'resolve'
		public Keyword getResolveKeyword_15() { return cResolveKeyword_15; }
	}
	...
	public class FunctionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cTargetAssignment_0_0_1_0 = (Assignment)cGroup_0_0_1.eContents().get(0);
		private final RuleCall cTargetLOWERCASE_IDTerminalRuleCall_0_0_1_0_0 = (RuleCall)cTargetAssignment_0_0_1_0.eContents().get(0);
		private final Keyword cLessThanSignLessThanSignKeyword_0_0_1_1 = (Keyword)cGroup_0_0_1.eContents().get(1);
		private final Group cGroup_0_0_2 = (Group)cAlternatives_0_0.eContents().get(2);
		private final Assignment cVariableAssignment_0_0_2_0 = (Assignment)cGroup_0_0_2.eContents().get(0);
		private final RuleCall cVariableLOWERCASE_IDTerminalRuleCall_0_0_2_0_0 = (RuleCall)cVariableAssignment_0_0_2_0.eContents().get(0);
		private final Keyword cLessThanSignHyphenMinusKeyword_0_0_2_1 = (Keyword)cGroup_0_0_2.eContents().get(1);
		...
		//Function:
		//	(mediated=LOWERCASE_ID '>>' | target=LOWERCASE_ID '<<' | variable=LOWERCASE_ID '<-')? (name=PathName '('
		//	parameters=ParameterList? ')' | urn=Urn | value=Literal | expression=EXPR) |
		//	'(' chain+=Function (',' chain+=Function)* ')' /* ('as' variable=LOWERCASE_ID)? */;
		@Override public ParserRule getRule() { return rule; }
		
		//(mediated=LOWERCASE_ID '>>' | target=LOWERCASE_ID '<<' | variable=LOWERCASE_ID '<-')? (name=PathName '('
		//parameters=ParameterList? ')' | urn=Urn | value=Literal | expression=EXPR) | '(' chain+=Function (','
		//chain+=Function)* ')'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//(mediated=LOWERCASE_ID '>>' | target=LOWERCASE_ID '<<' | variable=LOWERCASE_ID '<-')?
		...
		//target=LOWERCASE_ID
		public Assignment getTargetAssignment_0_0_1_0() { return cTargetAssignment_0_0_1_0; }
		
		//LOWERCASE_ID
		public RuleCall getTargetLOWERCASE_IDTerminalRuleCall_0_0_1_0_0() { return cTargetLOWERCASE_IDTerminalRuleCall_0_0_1_0_0; }
		
		//'<<'
		public Keyword getLessThanSignLessThanSignKeyword_0_0_1_1() { return cLessThanSignLessThanSignKeyword_0_0_1_1; }
		
		//variable=LOWERCASE_ID '<-'
		public Group getGroup_0_0_2() { return cGroup_0_0_2; }
		
		//variable=LOWERCASE_ID
		public Assignment getVariableAssignment_0_0_2_0() { return cVariableAssignment_0_0_2_0; }
		
		//LOWERCASE_ID
		public RuleCall getVariableLOWERCASE_IDTerminalRuleCall_0_0_2_0_0() { return cVariableLOWERCASE_IDTerminalRuleCall_0_0_2_0_0; }
		
		//'<-'
		public Keyword getLessThanSignHyphenMinusKeyword_0_0_2_1() { return cLessThanSignHyphenMinusKeyword_0_0_2_1; }
